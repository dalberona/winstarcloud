...
export class GatewayFormComponent extends PageComponent implements OnInit, OnDestroy {
  ...
  private buildForm(): void {
    this.gatewayConfigurationGroup = this.fb.group({
      ...
      caCertPath: ['/etc/winstarcloud-gateway/ca.pem'],
      privateKeyPath: ['/etc/winstarcloud-gateway/privateKey.pem'],
      certPath: ['/etc/winstarcloud-gateway/certificate.pem'],
