...
export const ruleChainNodeClazz = 'org.winstarcloud.rule.engine.flow.TbRuleChainInputNode';
export const outputNodeClazz = 'org.winstarcloud.rule.engine.flow.TbRuleChainOutputNode';

const ruleNodeClazzHelpLinkMap = {
  'org.winstarcloud.rule.engine.filter.TbCheckRelationNode': 'ruleNodeCheckRelation',
  'org.winstarcloud.rule.engine.filter.TbCheckMessageNode': 'ruleNodeCheckExistenceFields',
  'org.winstarcloud.rule.engine.geo.TbGpsGeofencingFilterNode': 'ruleNodeGpsGeofencingFilter',
  'org.winstarcloud.rule.engine.filter.TbJsFilterNode': 'ruleNodeJsFilter',
  'org.winstarcloud.rule.engine.filter.TbJsSwitchNode': 'ruleNodeJsSwitch',
  'org.winstarcloud.rule.engine.filter.TbAssetTypeSwitchNode': 'ruleNodeAssetProfileSwitch',
  'org.winstarcloud.rule.engine.filter.TbDeviceTypeSwitchNode': 'ruleNodeDeviceProfileSwitch',
  'org.winstarcloud.rule.engine.filter.TbCheckAlarmStatusNode': 'ruleNodeCheckAlarmStatus',
  'org.winstarcloud.rule.engine.filter.TbMsgTypeFilterNode': 'ruleNodeMessageTypeFilter',
  'org.winstarcloud.rule.engine.filter.TbMsgTypeSwitchNode': 'ruleNodeMessageTypeSwitch',
  'org.winstarcloud.rule.engine.filter.TbOriginatorTypeFilterNode': 'ruleNodeOriginatorTypeFilter',
  'org.winstarcloud.rule.engine.filter.TbOriginatorTypeSwitchNode': 'ruleNodeOriginatorTypeSwitch',
  'org.winstarcloud.rule.engine.metadata.TbGetAttributesNode': 'ruleNodeOriginatorAttributes',
  'org.winstarcloud.rule.engine.metadata.TbGetOriginatorFieldsNode': 'ruleNodeOriginatorFields',
  'org.winstarcloud.rule.engine.metadata.TbGetTelemetryNode': 'ruleNodeOriginatorTelemetry',
  'org.winstarcloud.rule.engine.metadata.TbGetCustomerAttributeNode': 'ruleNodeCustomerAttributes',
  'org.winstarcloud.rule.engine.metadata.TbGetCustomerDetailsNode': 'ruleNodeCustomerDetails',
  'org.winstarcloud.rule.engine.metadata.TbGetDeviceAttrNode': 'ruleNodeDeviceAttributes',
  'org.winstarcloud.rule.engine.metadata.TbGetRelatedAttributeNode': 'ruleNodeRelatedAttributes',
  'org.winstarcloud.rule.engine.metadata.TbGetTenantAttributeNode': 'ruleNodeTenantAttributes',
  'org.winstarcloud.rule.engine.metadata.TbGetTenantDetailsNode': 'ruleNodeTenantDetails',
  'org.winstarcloud.rule.engine.metadata.CalculateDeltaNode': 'ruleNodeCalculateDelta',
  'org.winstarcloud.rule.engine.transform.TbChangeOriginatorNode': 'ruleNodeChangeOriginator',
  'org.winstarcloud.rule.engine.transform.TbTransformMsgNode': 'ruleNodeTransformMsg',
  'org.winstarcloud.rule.engine.mail.TbMsgToEmailNode': 'ruleNodeMsgToEmail',
  'org.winstarcloud.rule.engine.action.TbAssignToCustomerNode': 'ruleNodeAssignToCustomer',
  'org.winstarcloud.rule.engine.action.TbUnassignFromCustomerNode': 'ruleNodeUnassignFromCustomer',
  'org.winstarcloud.rule.engine.action.TbClearAlarmNode': 'ruleNodeClearAlarm',
  'org.winstarcloud.rule.engine.action.TbCreateAlarmNode': 'ruleNodeCreateAlarm',
  'org.winstarcloud.rule.engine.action.TbCreateRelationNode': 'ruleNodeCreateRelation',
  'org.winstarcloud.rule.engine.action.TbDeleteRelationNode': 'ruleNodeDeleteRelation',
  'org.winstarcloud.rule.engine.delay.TbMsgDelayNode': 'ruleNodeMsgDelay',
  'org.winstarcloud.rule.engine.debug.TbMsgGeneratorNode': 'ruleNodeMsgGenerator',
  'org.winstarcloud.rule.engine.geo.TbGpsGeofencingActionNode': 'ruleNodeGpsGeofencingEvents',
  'org.winstarcloud.rule.engine.action.TbLogNode': 'ruleNodeLog',
  'org.winstarcloud.rule.engine.rpc.TbSendRPCReplyNode': 'ruleNodeRpcCallReply',
  'org.winstarcloud.rule.engine.rpc.TbSendRPCRequestNode': 'ruleNodeRpcCallRequest',
  'org.winstarcloud.rule.engine.telemetry.TbMsgAttributesNode': 'ruleNodeSaveAttributes',
  'org.winstarcloud.rule.engine.telemetry.TbMsgTimeseriesNode': 'ruleNodeSaveTimeseries',
  'org.winstarcloud.rule.engine.action.TbSaveToCustomCassandraTableNode': 'ruleNodeSaveToCustomTable',
  'org.winstarcloud.rule.engine.aws.lambda.TbLambdaNode': 'ruleNodeAwsLambda',
  'org.winstarcloud.rule.engine.aws.sns.TbSnsNode': 'ruleNodeAwsSns',
  'org.winstarcloud.rule.engine.aws.sqs.TbSqsNode': 'ruleNodeAwsSqs',
  'org.winstarcloud.rule.engine.kafka.TbKafkaNode': 'ruleNodeKafka',
  'org.winstarcloud.rule.engine.mqtt.TbMqttNode': 'ruleNodeMqtt',
  'org.winstarcloud.rule.engine.mqtt.azure.TbAzureIotHubNode': 'ruleNodeAzureIotHub',
  'org.winstarcloud.rule.engine.rabbitmq.TbRabbitMqNode': 'ruleNodeRabbitMq',
  'org.winstarcloud.rule.engine.rest.TbRestApiCallNode': 'ruleNodeRestApiCall',
  'org.winstarcloud.rule.engine.mail.TbSendEmailNode': 'ruleNodeSendEmail',
  'org.winstarcloud.rule.engine.sms.TbSendSmsNode': 'ruleNodeSendSms',
  'org.winstarcloud.rule.engine.edge.TbMsgPushToCloudNode': 'ruleNodePushToCloud',
  'org.winstarcloud.rule.engine.edge.TbMsgPushToEdgeNode': 'ruleNodePushToEdge',
  'org.winstarcloud.rule.engine.flow.TbRuleChainInputNode': 'ruleNodeRuleChain',
  'org.winstarcloud.rule.engine.flow.TbRuleChainOutputNode': 'ruleNodeOutputNode',
  'org.winstarcloud.rule.engine.math.TbMathNode': 'ruleNodeMath',
  'org.winstarcloud.rule.engine.rest.TbSendRestApiCallReplyNode': 'ruleNodeRestCallReply',
};
