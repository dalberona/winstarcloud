...
interface WinstarcloudArrayState extends JsonFormFieldState {
  model: any[];
  keys: number[];
}

class WinstarcloudArray extends React.Component<JsonFormFieldProps, WinstarcloudArrayState> {
...
export default WinstarcloudBaseComponent(WinstarcloudArray);
