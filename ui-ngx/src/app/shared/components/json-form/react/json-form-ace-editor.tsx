...
interface WinstarcloudAceEditorProps extends JsonFormFieldProps {
  mode: string;
  onTidy: (value: string) => Observable<string>;
}

interface WinstarcloudAceEditorState extends JsonFormFieldState {
  isFull: boolean;
...
class WinstarcloudAceEditor extends React.Component<WinstarcloudAceEditorProps, WinstarcloudAceEditorState> {
...
export default WinstarcloudBaseComponent(WinstarcloudAceEditor);
