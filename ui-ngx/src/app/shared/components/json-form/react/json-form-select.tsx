...
import WinstarcloudBaseComponent from '@shared/components/json-form/react/json-form-base-component';

interface WinstarcloudSelectState extends JsonFormFieldState {
  currentValue: any;
}

class WinstarcloudSelect extends React.Component<JsonFormFieldProps, WinstarcloudSelectState> {
...
export default WinstarcloudBaseComponent(WinstarcloudSelect);
