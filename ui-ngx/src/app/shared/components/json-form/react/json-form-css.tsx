...
class WinstarcloudCss extends React.Component<JsonFormFieldProps, JsonFormFieldState> {
    ...
    render() {
        return (
            <WinstarcloudAceEditor {...this.props} mode='css' onTidy={this.onTidyCss} {...this.state}></WinstarcloudAceEditor>
        );
    }
}

export default WinstarcloudCss;
