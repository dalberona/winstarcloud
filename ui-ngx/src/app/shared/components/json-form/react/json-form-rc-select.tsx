...
interface WinstarcloudRcSelectState extends JsonFormFieldState {
  currentValue: KeyLabelItem | KeyLabelItem[];
  items: Array<KeyLabelItem>;
  focused: boolean;
}

class WinstarcloudRcSelect extends React.Component<JsonFormFieldProps, WinstarcloudRcSelectState> {
...
export default WinstarcloudBaseComponent(WinstarcloudRcSelect);
