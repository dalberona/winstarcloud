...
interface WinstarcloudDateState extends JsonFormFieldState {
  currentValue: Date | null;
}

class WinstarcloudDate extends React.Component<JsonFormFieldProps, WinstarcloudDateState> {
...
export default WinstarcloudBaseComponent(WinstarcloudDate);
