...
class WinstarcloudHtml extends React.Component<JsonFormFieldProps, JsonFormFieldState> {
    ...
    render() {
        return (
            <WinstarcloudAceEditor {...this.props} mode='html' onTidy={this.onTidyHtml} {...this.state}></WinstarcloudAceEditor>
        );
    }
}

export default WinstarcloudHtml;
