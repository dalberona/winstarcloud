...
export default WinstarcloudBaseComponent => class<P extends JsonFormFieldProps>
  extends React.Component<P, JsonFormFieldState> {
    ...
    render() {
        if (this.props.form && this.props.form.schema) {
            return <WinstarcloudBaseComponent {...this.props} {...this.state} onChangeValidate={this.onChangeValidate}/>;
        } else {
            return <div></div>;
        }
    }
