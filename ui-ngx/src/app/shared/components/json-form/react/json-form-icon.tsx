...
interface WinstarcloudIconState extends JsonFormFieldState {
  icon: string | null;
  focused: boolean;
}

class WinstarcloudIcon extends React.Component<JsonFormFieldProps, WinstarcloudIconState> {
...
export default WinstarcloudBaseComponent(WinstarcloudIcon);
