...
interface WinstarcloudColorState extends JsonFormFieldState {
  color: tinycolor.ColorFormats.RGBA | null;
  focused: boolean;
}

class WinstarcloudColor extends React.Component<JsonFormFieldProps, WinstarcloudColorState> {
...
export default WinstarcloudBaseComponent(WinstarcloudColor);
