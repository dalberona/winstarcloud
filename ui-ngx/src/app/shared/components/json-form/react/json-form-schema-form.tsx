...
import WinstarcloudArray from './json-form-array';
import WinstarcloudJavaScript from './json-form-javascript';
import WinstarcloudJson from './json-form-json';
import WinstarcloudHtml from './json-form-html';
import WinstarcloudCss from './json-form-css';
import WinstarcloudColor from './json-form-color';
import WinstarcloudRcSelect from './json-form-rc-select';
import WinstarcloudNumber from './json-form-number';
import WinstarcloudText from './json-form-text';
import WinstarcloudSelect from './json-form-select';
import WinstarcloudRadios from './json-form-radios';
import WinstarcloudDate from './json-form-date';
import WinstarcloudImage from './json-form-image';
import WinstarcloudCheckbox from './json-form-checkbox';
import WinstarcloudHelp from './json-form-help';
import WinstarcloudFieldSet from './json-form-fieldset';
import WinstarcloudIcon from './json-form-icon';
import {
  JsonFormData,
  JsonFormProps,
  onChangeFn,
...
import WinstarcloudMarkdown from '@shared/components/json-form/react/json-form-markdown';
import { MouseEvent } from 'react';

class WinstarcloudSchemaForm extends React.Component<JsonFormProps, any> {
  ...
  constructor(props) {
    ...
    this.mapper = {
      number: WinstarcloudNumber,
      text: WinstarcloudText,
      password: WinstarcloudText,
      textarea: WinstarcloudText,
      select: WinstarcloudSelect,
      radios: WinstarcloudRadios,
      date: WinstarcloudDate,
      image: WinstarcloudImage,
      checkbox: WinstarcloudCheckbox,
      help: WinstarcloudHelp,
      array: WinstarcloudArray,
      javascript: WinstarcloudJavaScript,
      json: WinstarcloudJson,
      html: WinstarcloudHtml,
      css: WinstarcloudCss,
      markdown: WinstarcloudMarkdown,
      color: WinstarcloudColor,
      'rc-select': WinstarcloudRcSelect,
      fieldset: WinstarcloudFieldSet,
      icon: WinstarcloudIcon
    };
  ...
  render() {
    if (this.props.groupInfoes && this.props.groupInfoes.length > 0) {
      ...
      for (const info of this.props.groupInfoes) {
        ...
        const item = <WinstarcloudSchemaGroup key={content.length} forms={forms} info={info}></WinstarcloudSchemaGroup>;
        content.push(item);
      }
...
export default WinstarcloudSchemaForm;

interface WinstarcloudSchemaGroupProps {
  info: GroupInfo;
  forms: JSX.Element;
}

interface WinstarcloudSchemaGroupState {
  showGroup: boolean;
}

class WinstarcloudSchemaGroup extends React.Component<WinstarcloudSchemaGroupProps, WinstarcloudSchemaGroupState> {
  constructor(props) {
    super(props);
    this.state = {
      showGroup: true
