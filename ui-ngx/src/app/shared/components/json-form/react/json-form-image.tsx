...
interface WinstarcloudImageState extends JsonFormFieldState {
  imageUrl: string;
}

class WinstarcloudImage extends React.Component<JsonFormFieldProps, WinstarcloudImageState> {
...
export default WinstarcloudBaseComponent(WinstarcloudImage);
