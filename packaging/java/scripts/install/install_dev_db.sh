...
jarfile="${BASE}/winstarcloud-${project.version}-boot.jar"
...
sudo -u "$run_user" -s /bin/sh -c "java -cp ${jarfile} $JAVA_OPTS -Dloader.main=org.winstarcloud.server.WinstarcloudInstallApplication \
