...
import org.winstarcloud.server.dao.model.sql.NotificationRequestEntity;
import org.winstarcloud.server.dao.model.sql.NotificationRequestInfoEntity;
...
public interface NotificationRequestRepository extends JpaRepository<NotificationRequestEntity, UUID> {
    ...
    String REQUEST_INFO_QUERY = "SELECT new org.winstarcloud.server.dao.model.sql.NotificationRequestInfoEntity(r, t.name, t.configuration) " +
