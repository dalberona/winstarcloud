...
import org.winstarcloud.server.dao.model.sql.TenantEntity;
import org.winstarcloud.server.dao.model.sql.TenantInfoEntity;
...
public interface TenantRepository extends JpaRepository<TenantEntity, UUID> {
    ...
    @Query("SELECT new org.winstarcloud.server.dao.model.sql.TenantInfoEntity(t, p.name) " +
            "FROM TenantEntity t " +
