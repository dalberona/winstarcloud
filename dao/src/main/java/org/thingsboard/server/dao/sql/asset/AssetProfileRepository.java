 ...
 */
package org.winstarcloud.server.dao.sql.asset;
...
import org.winstarcloud.server.dao.ExportableEntityRepository;
import org.winstarcloud.server.dao.model.sql.AssetProfileEntity;
...
public interface AssetProfileRepository extends JpaRepository<AssetProfileEntity, UUID>, ExportableEntityRepository<AssetProfileEntity> {
    ...
    @Query("SELECT new org.winstarcloud.server.common.data.asset.AssetProfileInfo(a.id, a.tenantId, a.name, a.image, a.defaultDashboardId) " +
    ...
    @Query("SELECT new org.winstarcloud.server.common.data.EntityInfo(ap.id, 'ASSET_PROFILE', ap.name) " +
    ...
    @Query("SELECT new org.winstarcloud.server.common.data.EntityInfo(a.id, 'ASSET_PROFILE', a.name) " +
