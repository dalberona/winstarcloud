...
import org.winstarcloud.server.dao.device.DeviceConnectivityInfo;
...
public class DeviceConnectivityUtil {
    ...
    public static final String MQTT_IMAGE = "winstarcloud/mosquitto-clients ";
    public static final String COAP_IMAGE = "winstarcloud/coap-clients ";
    ...
    public static Resource getGatewayDockerComposeFile(String baseUrl, DeviceConnectivityInfo properties, DeviceCredentials deviceCredentials, String mqttType) throws URISyntaxException {
        ...
        dockerComposeBuilder.append("  # WinstarCloud IoT Gateway Service Configuration\n");
        dockerComposeBuilder.append("  tb-gateway:\n");
        dockerComposeBuilder.append("    image: winstarcloud/tb-gateway\n");
        ...
        dockerComposeBuilder.append("      - tb-gw-config:/winstarcloud_gateway/config\n");
        dockerComposeBuilder.append("      - tb-gw-logs:/winstarcloud_gateway/logs\n");
        dockerComposeBuilder.append("      - tb-gw-extensions:/winstarcloud_gateway/extensions\n");
        dockerComposeBuilder.append("\n");
