 ...
 */
package org.winstarcloud.server.dao.sql.widget;
...
import org.winstarcloud.server.dao.model.sql.WidgetTypeDetailsEntity;
import org.winstarcloud.server.dao.model.sql.WidgetTypeEntity;
import org.winstarcloud.server.dao.model.sql.WidgetTypeIdFqnEntity;
...
public interface WidgetTypeRepository extends JpaRepository<WidgetTypeDetailsEntity, UUID>, ExportableEntityRepository<WidgetTypeDetailsEntity> {
    ...
    @Query("SELECT new org.winstarcloud.server.dao.model.sql.WidgetTypeIdFqnEntity(wtd.id, wtd.fqn) FROM WidgetTypeDetailsEntity wtd " +
