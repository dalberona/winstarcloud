 ...
 */
package org.winstarcloud.server.dao.mobile;
...
import org.winstarcloud.server.common.data.mobile.BadgePosition;
...
public class BaseMobileAppSettingsService extends AbstractCachedEntityService<TenantId, MobileAppSettings, MobileAppSettingsEvictEvent> implements MobileAppSettingsService {
    ...
    @Value("${mobileApp.googlePlayLink:https://play.google.com/store/apps/details?id=org.winstarcloud.demo.app}")
    private String googlePlayLink;
    @Value("${mobileApp.appStoreLink:https://apps.apple.com/us/app/winstarcloud-live/id1594355695}")
