...
import org.winstarcloud.server.common.data.util.ReflectionUtils;
...
import org.winstarcloud.server.dao.service.validator.RuleChainDataValidator;
...
import static org.winstarcloud.server.common.data.DataConstants.TENANT;
import static org.winstarcloud.server.dao.service.Validator.validateId;
import static org.winstarcloud.server.dao.service.Validator.validateIds;
import static org.winstarcloud.server.dao.service.Validator.validatePageLink;
import static org.winstarcloud.server.dao.service.Validator.validatePositiveNumber;
...
public class BaseRuleChainService extends AbstractEntityService implements RuleChainService {
    ...
    public static final String TB_RULE_CHAIN_INPUT_NODE = "org.winstarcloud.rule.engine.flow.TbRuleChainInputNode";
    @Autowired
        ...
        if (nodes != null) {
            ...
            if (ruleChainMetaData.getRuleChainConnections() != null) {
                for (RuleChainConnectionInfo nodeToRuleChainConnection : ruleChainMetaData.getRuleChainConnections()) {
                    ...
                    targetNode.setType("org.winstarcloud.rule.engine.flow.TbRuleChainInputNode");
    ...
    private void setSingletonMode(RuleNode ruleNode) {
        ...
        try {
            ComponentClusteringMode nodeConfigType = ReflectionUtils.getAnnotationProperty(ruleNode.getType(),
                    "org.winstarcloud.rule.engine.api.RuleNode", "clusteringMode");
