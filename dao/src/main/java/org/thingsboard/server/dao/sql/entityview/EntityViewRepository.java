 ...
 */
package org.winstarcloud.server.dao.sql.entityview;
...
import org.winstarcloud.server.dao.model.sql.EntityViewEntity;
import org.winstarcloud.server.dao.model.sql.EntityViewInfoEntity;
...
public interface EntityViewRepository extends JpaRepository<EntityViewEntity, UUID>, ExportableEntityRepository<EntityViewEntity> {
    ...
    @Query("SELECT new org.winstarcloud.server.dao.model.sql.EntityViewInfoEntity(e, c.title, c.additionalInfo) " +
