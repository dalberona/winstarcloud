 ...
 */
package org.winstarcloud.server.dao.audit.sink;
...
public class ElasticsearchAuditLogSink implements AuditLogSink {
    ...
    public void init() {
        try {
            ...
            this.executor = Executors.newSingleThreadExecutor(WinstarCloudThreadFactory.forName("elasticsearch-audit-log"));
        } catch (Exception e) {
