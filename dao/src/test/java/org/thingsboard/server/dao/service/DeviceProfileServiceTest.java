...
public class DeviceProfileServiceTest extends AbstractServiceTest {
    ...
    public void testFindOrCreateDeviceProfile() throws ExecutionException, InterruptedException {
        ListeningExecutorService testExecutor = MoreExecutors.listeningDecorator(Executors.newFixedThreadPool(100, WinstarCloudThreadFactory.forName(getClass().getSimpleName() + "-test-scope")));
        try {
