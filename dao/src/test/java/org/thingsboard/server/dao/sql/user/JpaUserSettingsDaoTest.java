 ...
 */
package org.winstarcloud.server.dao.sql.user;
...
import org.winstarcloud.server.common.data.settings.UserSettingsCompositeKey;
import org.winstarcloud.server.common.data.settings.UserSettingsType;
import org.winstarcloud.server.dao.AbstractJpaDaoTest;
import org.winstarcloud.server.dao.service.AbstractServiceTest;
import org.winstarcloud.server.dao.user.UserDao;
import org.winstarcloud.server.dao.user.UserSettingsDao;
...
import static org.winstarcloud.server.dao.service.AbstractServiceTest.SYSTEM_TENANT_ID;
...
public class JpaUserSettingsDaoTest extends AbstractJpaDaoTest {
    ...
    private User saveUser(UUID tenantId, UUID customerId) {
        ...
        String email = idString.substring(0, idString.indexOf('-')) + "@winstarcloud.org";
        user.setEmail(email);
