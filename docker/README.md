# Docker configuration for WinstarCloud Microservices

This folder containing scripts and Docker Compose configurations to run WinstarCloud in Microservices mode.
...
- `FROM_VERSION` - from which version upgrade should be started. See [Upgrade Instructions](https://winstarcloud.com/docs/user-guide/install/upgrade-instructions) for valid `fromVersion` values.
