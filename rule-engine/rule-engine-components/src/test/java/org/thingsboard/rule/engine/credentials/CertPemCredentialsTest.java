 ...
 */
package org.winstarcloud.rule.engine.credentials;
...
import org.winstarcloud.common.util.SslUtil;
...
import static org.winstarcloud.rule.engine.credentials.CertPemCredentials.CERT_ALIAS_PREFIX;
import static org.winstarcloud.rule.engine.credentials.CertPemCredentials.PRIVATE_KEY_ALIAS;
...
public class CertPemCredentialsTest {
    ...
    public void testChainOfCertificates() throws Exception {
        ...
        Assertions.assertEquals("CN=*.winstarcloud.cloud, O=\"WinstarCloud, Inc.\", ST=New York, C=US",
