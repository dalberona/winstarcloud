 ...
 */
package org.winstarcloud.rule.engine.kafka;
...
import org.winstarcloud.server.common.data.exception.WinstarcloudKafkaClientError;
    ...
    public void init(TbContext ctx, TbNodeConfiguration configuration) throws TbNodeException {
        ...
        try {
            ...
            ioThread.setUncaughtExceptionHandler((thread, throwable) -> {
                if (throwable instanceof WinstarcloudKafkaClientError) {
                    initError = throwable;
                    destroy();
                }
            });
