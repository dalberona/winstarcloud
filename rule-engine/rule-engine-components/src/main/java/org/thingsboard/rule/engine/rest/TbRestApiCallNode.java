 ...
 */
package org.winstarcloud.rule.engine.rest;
...
@RuleNode(
        ...
        nodeDetails = "Will invoke REST API call <code>GET | POST | PUT | DELETE</code> to external REST server. " +
                ...
                "and if your proxy with auth, the next ones  should be added: \"tb.proxy.user\" and \"tb.proxy.password\" to the winstarcloud.conf file.",
