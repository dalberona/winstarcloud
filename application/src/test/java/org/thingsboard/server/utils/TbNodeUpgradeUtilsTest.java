...
import org.winstarcloud.rule.engine.metadata.TbGetCustomerAttributeNode;
import org.winstarcloud.rule.engine.metadata.TbGetEntityDataNodeConfiguration;
...
public class TbNodeUpgradeUtilsTest {
    ...
    public void testUpgradeRuleNodeConfigurationWithNullConfig() throws Exception {
        ...
        var annotation = mock(org.winstarcloud.rule.engine.api.RuleNode.class);
