 ...
 */
package org.winstarcloud.server.transport.mqtt.sparkplug;
...
import org.winstarcloud.server.transport.mqtt.mqttv5.MqttV5TestClient;
...
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.MetricDataType.Bytes;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.MetricDataType.Int16;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.MetricDataType.Int32;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.MetricDataType.Int64;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.MetricDataType.Int8;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.MetricDataType.UInt16;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.MetricDataType.UInt32;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.MetricDataType.UInt64;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.MetricDataType.UInt8;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.SparkplugMetricUtil.createMetric;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.SparkplugTopicUtil.NAMESPACE;
...
public abstract class AbstractMqttV5ClientSparkplugTest extends AbstractMqttIntegrationTest {
    ...
    protected void createdAddMetricValuePrimitiveTsKv(List<TsKvEntry> listTsKvEntry, List<String> listKeys,
                                                      SparkplugBProto.Payload.Builder dataPayload, long ts) throws WinstarcloudException {
    ...
    private TsKvEntry createdAddMetricTsKvLong(SparkplugBProto.Payload.Builder dataPayload, String key, Object value,
                                               long ts, MetricDataType metricDataType) throws WinstarcloudException {
    ...
    private void createdAddMetricTsKvJson(SparkplugBProto.Payload.Builder dataPayload, String key,
                                          ...
                                          List<String> listKeys) throws WinstarcloudException {
