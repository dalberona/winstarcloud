 ...
 */
package org.winstarcloud.server.transport.lwm2m.client;
...
import static org.winstarcloud.server.transport.lwm2m.AbstractLwM2MIntegrationTest.serverId;
import static org.winstarcloud.server.transport.lwm2m.AbstractLwM2MIntegrationTest.serverIdBs;
import static org.winstarcloud.server.transport.lwm2m.AbstractLwM2MIntegrationTest.shortServerId;
import static org.winstarcloud.server.transport.lwm2m.AbstractLwM2MIntegrationTest.shortServerIdBs0;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.BINARY_APP_DATA_CONTAINER;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_BOOTSTRAP_FAILURE;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_BOOTSTRAP_STARTED;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_BOOTSTRAP_SUCCESS;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_BOOTSTRAP_TIMEOUT;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_DEREGISTRATION_FAILURE;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_DEREGISTRATION_STARTED;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_DEREGISTRATION_SUCCESS;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_DEREGISTRATION_TIMEOUT;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_EXPECTED_ERROR;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_INIT;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_REGISTRATION_FAILURE;
...
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_REGISTRATION_TIMEOUT;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_UPDATE_FAILURE;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_UPDATE_STARTED;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_UPDATE_SUCCESS;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState.ON_UPDATE_TIMEOUT;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.OBJECT_INSTANCE_ID_0;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.OBJECT_INSTANCE_ID_1;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.OBJECT_INSTANCE_ID_12;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.TEMPERATURE_SENSOR;
import static org.winstarcloud.server.transport.lwm2m.Lwm2mTestHelper.resources;
import static org.winstarcloud.server.transport.lwm2m.utils.LwM2MTransportUtil.setDtlsConnectorConfigCidLength;
