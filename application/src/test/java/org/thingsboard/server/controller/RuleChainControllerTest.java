...
import org.winstarcloud.rule.engine.action.TbCreateAlarmNode;
import org.winstarcloud.rule.engine.action.TbCreateAlarmNodeConfiguration;
import org.winstarcloud.rule.engine.metadata.TbGetRelatedAttributeNode;
import org.winstarcloud.rule.engine.metadata.TbGetRelatedDataNodeConfiguration;
...
import org.winstarcloud.server.dao.rule.RuleChainDao;
...
public class RuleChainControllerTest extends AbstractControllerTest {
    ...
    public void testSaveRuleChainMetadataWithVersionedNodes() throws Exception {
        ...
        var annotation = TbGetRelatedAttributeNode.class.getAnnotation(org.winstarcloud.rule.engine.api.RuleNode.class);
