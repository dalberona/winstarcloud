...
import org.winstarcloud.server.service.security.auth.mfa.provider.impl.OtpBasedTwoFaProvider;
import org.winstarcloud.server.service.security.auth.mfa.provider.impl.TotpTwoFaProvider;
...
public class TwoFactorAuthConfigTest extends AbstractControllerTest {
    ...
    public void testSubmitTotpTwoFaAccountConfig_validationError() throws Exception {
        ...
        totpTwoFaAccountConfig.setAuthUrl("otpauth://totp/WinstarCloud%20(Tenant):tenant@winstarcloud.org?issuer=WinstarCloud+%28Tenant%29&secret=FUNBIM3CXFNNGQR6ZIPVWHP65PPFWDII");
