...
import org.winstarcloud.server.common.data.security.model.mfa.account.TotpTwoFaAccountConfig;
...
import org.winstarcloud.server.common.data.security.model.mfa.provider.TotpTwoFaProviderConfig;
...
public class TwoFactorAuthTest extends AbstractControllerTest {
    ...
    @Test
    public void testAuthWithoutTwoFaAccountConfig() throws WinstarcloudException {
        configureTotpTwoFa();
    ...
    public void testTwoFa_multipleProviders() throws Exception {
        ...
        twoFaUser.setEmail("2fa@winstarcloud.org");
    ...
    private TotpTwoFaAccountConfig configureTotpTwoFa(Consumer<PlatformTwoFaSettings>... customizer) throws WinstarcloudException {
        TotpTwoFaProviderConfig totpTwoFaProviderConfig = new TotpTwoFaProviderConfig();
        totpTwoFaProviderConfig.setIssuerName("tb");
    ...
    private SmsTwoFaAccountConfig configureSmsTwoFa(Consumer<SmsTwoFaProviderConfig>... customizer) throws WinstarcloudException {
        SmsTwoFaProviderConfig smsTwoFaProviderConfig = new SmsTwoFaProviderConfig();
        smsTwoFaProviderConfig.setVerificationCodeLifetime(60);
        smsTwoFaProviderConfig.setSmsVerificationMessageTemplate("${code}");
