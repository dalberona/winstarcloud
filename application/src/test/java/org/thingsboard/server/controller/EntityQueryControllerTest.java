...
public class EntityQueryControllerTest extends AbstractControllerTest {
    ...
    private static final String CUSTOMER_USER_EMAIL = "entityQueryCustomer@winstarcloud.org";
    private static final String TENANT_PASSWORD = "testPassword1";
    private static final String CUSTOMER_USER_PASSWORD = "customer";
    private static final String TENANT_EMAIL = "entityQueryTenant@winstarcloud.org";
