...
import org.winstarcloud.server.common.data.sync.ie.importing.csv.BulkImportColumnType;
...
import org.winstarcloud.server.service.gateway_device.GatewayNotificationsService;
...
public class DeviceControllerTest extends AbstractControllerTest {
    ...
    public void beforeTest() throws Exception {
        executor = MoreExecutors.listeningDecorator(WinstarCloudExecutors.newWorkStealingPool(8, getClass()));
    ...
    public void testAssignDeviceToCustomerFromDifferentTenant() throws Exception {
        ...
        tenantAdmin2.setEmail("tenant3@winstarcloud.org");
    ...
    public void testAssignDeviceToTenant() throws Exception {
        ...
        user.setEmail("tenant9@winstarcloud.org");
        ...
        login("tenant9@winstarcloud.org", "testPassword1");
