 ...
 */
package org.winstarcloud.server.service.entitiy.alarmComment;
...
import org.winstarcloud.server.service.entitiy.alarm.DefaultTbAlarmCommentService;
...
public class DefaultTbAlarmCommentServiceTest {
    ...
    @Test
    public void testSave() throws WinstarcloudException {
        var alarm = new Alarm();
    ...
    @Test
    public void testDelete() throws WinstarcloudException {
    ...
    public void testShouldNotDeleteSystemComment() {
        ...
        assertThatThrownBy(() -> service.deleteAlarmComment(new Alarm(alarmId), alarmComment, new User()))
                .isInstanceOf(WinstarcloudException.class)
