...
public class DefaultTbAlarmServiceTest {
    ...
    @Test
    public void testAck() throws WinstarcloudException {
        var alarm = new Alarm();
    ...
    @Test
    public void testClear() throws WinstarcloudException {
        var alarm = new Alarm();
    ...
    @Test
    public void testUnassignAlarm() throws WinstarcloudException {
    ...
    @Test
    public void testUnassignDeletedUserAlarms() throws WinstarcloudException {
        AlarmInfo alarm = new AlarmInfo();
        alarm.setId(new AlarmId(UUID.randomUUID()));
