...
import org.winstarcloud.rule.engine.api.notification.FirebaseService;
...
import org.winstarcloud.server.common.data.notification.NotificationRequestPreview;
...
import org.winstarcloud.server.common.data.notification.info.AlarmCommentNotificationInfo;
...
import org.winstarcloud.server.common.data.notification.settings.MobileAppNotificationDeliveryMethodConfig;
...
import org.winstarcloud.server.common.data.notification.settings.UserNotificationSettings;
import org.winstarcloud.server.common.data.notification.targets.MicrosoftTeamsNotificationTargetConfig;
import org.winstarcloud.server.common.data.notification.targets.NotificationTarget;
import org.winstarcloud.server.common.data.notification.targets.platform.AllUsersFilter;
...
import org.winstarcloud.server.common.data.notification.targets.platform.UserListFilter;
import org.winstarcloud.server.common.data.notification.targets.slack.SlackConversation;
import org.winstarcloud.server.common.data.notification.targets.slack.SlackConversationType;
import org.winstarcloud.server.common.data.notification.targets.slack.SlackNotificationTargetConfig;
import org.winstarcloud.server.common.data.notification.template.DeliveryMethodNotificationTemplate;
import org.winstarcloud.server.common.data.notification.template.EmailDeliveryMethodNotificationTemplate;
import org.winstarcloud.server.common.data.notification.template.MicrosoftTeamsDeliveryMethodNotificationTemplate;
import org.winstarcloud.server.common.data.notification.template.MicrosoftTeamsDeliveryMethodNotificationTemplate.Button.LinkType;
import org.winstarcloud.server.common.data.notification.template.MobileAppDeliveryMethodNotificationTemplate;
import org.winstarcloud.server.common.data.notification.template.NotificationTemplate;
import org.winstarcloud.server.common.data.notification.template.NotificationTemplateConfig;
import org.winstarcloud.server.common.data.notification.template.SlackDeliveryMethodNotificationTemplate;
import org.winstarcloud.server.common.data.notification.template.SmsDeliveryMethodNotificationTemplate;
import org.winstarcloud.server.common.data.notification.template.WebDeliveryMethodNotificationTemplate;
...
import org.winstarcloud.server.service.notification.channels.MicrosoftTeamsNotificationChannel;
import org.winstarcloud.server.service.ws.notification.cmd.UnreadNotificationsUpdate;
...
public class NotificationApiTest extends AbstractNotificationApiTest {
    ...
    public void testNotificationUpdatesForSeveralUsers() throws Exception {
        ...
        for (int i = 1; i <= usersCount; i++) {
            ...
            user.setEmail("test-user-" + i + "@winstarcloud.org");
    ...
    public void testNotificationRequestPreview() throws Exception {
        ...
        for (int i = 0; i < customerUsersCount; i++) {
            ...
            customerUser.setEmail("other-customer-" + i + "@winstarcloud.org");
