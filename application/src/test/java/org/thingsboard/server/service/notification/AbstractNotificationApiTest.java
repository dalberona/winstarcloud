...
import org.winstarcloud.server.common.data.notification.settings.NotificationDeliveryMethodConfig;
...
import org.winstarcloud.server.common.data.notification.template.HasSubject;
...
public abstract class AbstractNotificationApiTest extends AbstractControllerTest {
    ...
    protected Pair<User, NotificationApiWsClient> createUserAndConnectWsClient(Authority authority) throws Exception {
        ...
        user.setEmail(RandomStringUtils.randomAlphabetic(20) + "@winstarcloud.com");
