 ...
 */
package org.winstarcloud.server.rules.flow;
...
import org.winstarcloud.server.controller.AbstractRuleEngineControllerTest;
...
public abstract class AbstractRuleEngineFlowIntegrationTest extends AbstractRuleEngineControllerTest {
    ...
    public void testTwoRuleChainsWithTwoRules() throws Exception {
        ...
        ruleNode12.setType(org.winstarcloud.rule.engine.flow.TbRuleChainInputNode.class.getName());
