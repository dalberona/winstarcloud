 ...
 */
package org.winstarcloud.server.rules.lifecycle;
...
public abstract class AbstractRuleEngineLifecycleIntegrationTest extends AbstractRuleEngineControllerTest {
    ...
    public void testRuleChainWithOneRule() throws Exception {
        ...
        ruleNode.setType(org.winstarcloud.rule.engine.metadata.TbGetAttributesNode.class.getName());
        ruleNode.setConfigurationVersion(TbGetAttributesNode.class.getAnnotation(org.winstarcloud.rule.engine.api.RuleNode.class).version());
