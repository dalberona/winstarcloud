...
public interface TbEntityRelationService {
    ...
    void save(TenantId tenantId, CustomerId customerId, EntityRelation entity, User user) throws WinstarcloudException;

    void delete(TenantId tenantId, CustomerId customerId, EntityRelation entity, User user) throws WinstarcloudException;

    void deleteCommonRelations(TenantId tenantId, CustomerId customerId, EntityId entityId, User user) throws WinstarcloudException;
