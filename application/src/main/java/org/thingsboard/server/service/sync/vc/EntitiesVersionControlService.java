...
public interface EntitiesVersionControlService {
    ...
    VersionCreationResult getVersionCreateStatus(User user, UUID requestId) throws WinstarcloudException;
    ...
    VersionLoadResult getVersionLoadStatus(User user, UUID requestId) throws WinstarcloudException;
