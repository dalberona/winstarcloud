...
import org.winstarcloud.server.dao.util.KvUtils;
...
public class DefaultTelemetrySubscriptionService extends AbstractSubscriptionService implements TelemetrySubscriptionService {
    ...
    public void initExecutor() {
        super.initExecutor();
        tsCallBackExecutor = Executors.newSingleThreadExecutor(WinstarCloudThreadFactory.forName("ts-service-ts-callback"));
    }
