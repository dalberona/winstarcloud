...
import org.winstarcloud.server.dao.cassandra.CassandraInstallCluster;
import org.winstarcloud.server.service.install.cql.CQLStatementsParser;
...
public abstract class CassandraAbstractDatabaseSchemaService implements DatabaseSchemaService {
    ...
    private static final String CASSANDRA_STANDARD_KEYSPACE = "winstarcloud";
