...
public interface TbAlarmCommentService {
    ...
    AlarmComment saveAlarmComment(Alarm alarm, AlarmComment alarmComment, User user) throws WinstarcloudException;

    void deleteAlarmComment(Alarm alarm, AlarmComment alarmComment, User user) throws WinstarcloudException;
}
