...
import org.winstarcloud.server.service.edge.rpc.fetch.AdminSettingsEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.AssetProfilesEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.AssetsEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.CustomerEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.CustomerUsersEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.DashboardsEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.DefaultProfilesEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.DeviceProfilesEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.DevicesEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.EdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.EntityViewsEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.NotificationRuleEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.NotificationTargetEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.NotificationTemplateEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.OAuth2EdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.OtaPackagesEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.QueuesEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.RuleChainsEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.SystemWidgetTypesEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.SystemWidgetsBundlesEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.TenantAdminUsersEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.TenantEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.TenantResourcesEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.TenantWidgetTypesEdgeEventFetcher;
import org.winstarcloud.server.service.edge.rpc.fetch.TenantWidgetsBundlesEdgeEventFetcher;
