...
public class DefaultTbAlarmCommentService extends AbstractTbEntityService implements TbAlarmCommentService{
    ...
    @Override
    public AlarmComment saveAlarmComment(Alarm alarm, AlarmComment alarmComment, User user) throws WinstarcloudException {
    ...
    @Override
    public void deleteAlarmComment(Alarm alarm, AlarmComment alarmComment, User user) throws WinstarcloudException {
        if (alarmComment.getType() == AlarmCommentType.OTHER) {
            ...
            throw new WinstarcloudException("System comment could not be deleted", WinstarcloudErrorCode.BAD_REQUEST_PARAMS);
        }
    }
}
