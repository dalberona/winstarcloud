...
public interface TbTenantProfileService {
    ...
    TenantProfile save(TenantId tenantId, TenantProfile tenantProfile, TenantProfile oldTenantProfile) throws WinstarcloudException;

    void delete(TenantId tenantId, TenantProfile tenantProfile) throws WinstarcloudException;
}
