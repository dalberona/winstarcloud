 ...
 */
package org.winstarcloud.server.service.install.migrate;
...
import org.winstarcloud.server.common.data.UUIDConverter;
...
import org.winstarcloud.server.dao.sqlts.dictionary.KeyDictionaryRepository;
import org.winstarcloud.server.dao.sqlts.insert.latest.InsertLatestTsRepository;
import org.winstarcloud.server.dao.util.NoSqlTsDao;
import org.winstarcloud.server.dao.util.SqlTsLatestDao;
...
import static org.winstarcloud.server.service.install.migrate.CassandraToSqlColumn.bigintColumn;
import static org.winstarcloud.server.service.install.migrate.CassandraToSqlColumn.booleanColumn;
import static org.winstarcloud.server.service.install.migrate.CassandraToSqlColumn.doubleColumn;
import static org.winstarcloud.server.service.install.migrate.CassandraToSqlColumn.idColumn;
import static org.winstarcloud.server.service.install.migrate.CassandraToSqlColumn.jsonColumn;
import static org.winstarcloud.server.service.install.migrate.CassandraToSqlColumn.stringColumn;
...
public class CassandraTsLatestToSqlMigrateService implements TsLatestMigrateService {
    ...
    public void migrate() throws Exception {
        ...
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUserName, dbPassword)) {
            ...
            log.error("Unexpected error during WinstarCloud entities data migration!", e);
            throw e;
        }
    }
    ...
    private void loadSql(Path sqlFile, Connection conn) throws Exception {
        ...
        conn.createStatement().execute(sql); //NOSONAR, ignoring because method used to execute winstarcloud database upgrade script
        Thread.sleep(5000);
    }
}
