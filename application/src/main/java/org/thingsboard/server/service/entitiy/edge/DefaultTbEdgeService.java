...
public class DefaultTbEdgeService extends AbstractTbEntityService implements TbEdgeService {
    ...
    @Override
    public Edge assignEdgeToCustomer(TenantId tenantId, EdgeId edgeId, Customer customer, User user) throws WinstarcloudException {
    ...
    @Override
    public Edge unassignEdgeFromCustomer(Edge edge, Customer customer, User user) throws WinstarcloudException {
    ...
    @Override
    public Edge assignEdgeToPublicCustomer(TenantId tenantId, EdgeId edgeId, User user) throws WinstarcloudException {
        ActionType actionType = ActionType.ASSIGNED_TO_CUSTOMER;
