 ...
 */
package org.winstarcloud.server.service.queue.consumer;
...
import org.winstarcloud.server.service.queue.ruleengine.QueueEvent;
import org.winstarcloud.server.service.queue.ruleengine.TbQueueConsumerManagerTask;
import org.winstarcloud.server.service.queue.ruleengine.TbQueueConsumerTask;
...
public class MainQueueConsumerManager<M extends TbQueueMsg, C extends QueueConfig> {
    ...
    private void launchConsumer(TbQueueConsumerTask<M> consumerTask) {
        ...
        Future<?> consumerLoop = consumerExecutor.submit(() -> {
            WinstarCloudThreadFactory.updateCurrentThreadName(consumerTask.getKey().toString());
            try {
