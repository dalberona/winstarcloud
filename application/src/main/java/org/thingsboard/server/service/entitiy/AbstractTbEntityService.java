...
public abstract class AbstractTbEntityService {
    ...
    protected <T> T checkNotNull(T reference) throws WinstarcloudException {
        return checkNotNull(reference, "Requested item wasn't found!");
    }

    protected <T> T checkNotNull(T reference, String notFoundMessage) throws WinstarcloudException {
        if (reference == null) {
    ...
    protected <T> T checkNotNull(Optional<T> reference) throws WinstarcloudException {
        return checkNotNull(reference, "Requested item wasn't found!");
    }

    protected <T> T checkNotNull(Optional<T> reference, String notFoundMessage) throws WinstarcloudException {
