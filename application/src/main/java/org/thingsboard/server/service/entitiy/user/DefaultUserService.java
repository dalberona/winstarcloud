...
import static org.winstarcloud.server.controller.UserController.ACTIVATE_URL_PATTERN;
...
public class DefaultUserService extends AbstractTbEntityService implements TbUserService {
    ...
    public User save(TenantId tenantId, CustomerId customerId, User tbUser, boolean sendActivationMail,
                     HttpServletRequest request, User user) throws WinstarcloudException {
    ...
    @Override
    public void delete(TenantId tenantId, CustomerId customerId, User user, User responsibleUser) throws WinstarcloudException {
