...
import org.winstarcloud.server.common.data.JavaSerDesUtil;
import org.winstarcloud.server.common.data.alarm.AlarmInfo;
import org.winstarcloud.server.common.data.event.ErrorEvent;
import org.winstarcloud.server.common.data.event.Event;
import org.winstarcloud.server.common.data.event.LifecycleEvent;
...
import org.winstarcloud.server.common.data.queue.QueueConfig;
import org.winstarcloud.server.common.data.rpc.RpcError;
...
import org.winstarcloud.server.common.msg.rpc.ToDeviceRpcRequestActorMsg;
import org.winstarcloud.server.common.stats.StatsFactory;
import org.winstarcloud.server.common.util.KvProtoUtil;
import org.winstarcloud.server.common.util.ProtoUtils;
import org.winstarcloud.server.dao.resource.ImageCacheKey;
...
import org.winstarcloud.server.gen.transport.TransportProtos.DeviceStateServiceMsgProto;
import org.winstarcloud.server.gen.transport.TransportProtos.EdgeNotificationMsgProto;
import org.winstarcloud.server.gen.transport.TransportProtos.ErrorEventProto;
import org.winstarcloud.server.gen.transport.TransportProtos.FromDeviceRPCResponseProto;
import org.winstarcloud.server.gen.transport.TransportProtos.LifecycleEventProto;
import org.winstarcloud.server.gen.transport.TransportProtos.LocalSubscriptionServiceMsgProto;
import org.winstarcloud.server.gen.transport.TransportProtos.SubscriptionMgrMsgProto;
import org.winstarcloud.server.gen.transport.TransportProtos.TbAlarmDeleteProto;
import org.winstarcloud.server.gen.transport.TransportProtos.TbAlarmUpdateProto;
import org.winstarcloud.server.gen.transport.TransportProtos.TbAttributeDeleteProto;
import org.winstarcloud.server.gen.transport.TransportProtos.TbAttributeUpdateProto;
import org.winstarcloud.server.gen.transport.TransportProtos.TbEntitySubEventProto;
import org.winstarcloud.server.gen.transport.TransportProtos.TbTimeSeriesDeleteProto;
import org.winstarcloud.server.gen.transport.TransportProtos.TbTimeSeriesUpdateProto;
...
import org.winstarcloud.server.service.edge.EdgeNotificationService;
import org.winstarcloud.server.service.notification.NotificationSchedulerService;
...
import org.winstarcloud.server.service.queue.consumer.MainQueueConsumerManager;
import org.winstarcloud.server.service.queue.processing.AbstractConsumerService;
import org.winstarcloud.server.service.queue.processing.IdMsgPair;
import org.winstarcloud.server.service.resource.TbImageService;
import org.winstarcloud.server.service.rpc.TbCoreDeviceRpcService;
...
import org.winstarcloud.server.service.subscription.SubscriptionManagerService;
import org.winstarcloud.server.service.subscription.TbLocalSubscriptionService;
import org.winstarcloud.server.service.subscription.TbSubscriptionUtils;
import org.winstarcloud.server.service.sync.vc.GitVersionControlQueueService;
import org.winstarcloud.server.service.transport.msg.TransportToDeviceActorMsgWrapper;
...
public class DefaultTbCoreConsumerService extends AbstractConsumerService<ToCoreNotificationMsg> implements TbCoreConsumerService {
    ...
    public void init() {
        super.init("tb-core");
        this.deviceActivityEventsExecutor = MoreExecutors.listeningDecorator(Executors.newSingleThreadExecutor(WinstarCloudThreadFactory.forName("tb-core-device-activity-events-executor")));
