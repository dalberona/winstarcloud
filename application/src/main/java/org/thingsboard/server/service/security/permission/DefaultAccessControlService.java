 ...
 */
package org.winstarcloud.server.service.security.permission;
...
public class DefaultAccessControlService implements AccessControlService {
    ...
    @Override
    public void checkPermission(SecurityUser user, Resource resource, Operation operation) throws WinstarcloudException {
    ...
    public <I extends EntityId, T extends HasTenantId> void checkPermission(SecurityUser user, Resource resource,
                                                                                            Operation operation, I entityId, T entity) throws WinstarcloudException {
        PermissionChecker permissionChecker = getPermissionChecker(user.getAuthority(), resource);
    ...
    private PermissionChecker getPermissionChecker(Authority authority, Resource resource) throws WinstarcloudException {
    ...
    private void permissionDenied() throws WinstarcloudException {
