...
import org.winstarcloud.server.common.data.alarm.AlarmAssignee;
...
public class DefaultTbAlarmService extends AbstractTbEntityService implements TbAlarmService {
    ...
    @Override
    public Alarm save(Alarm alarm, User user) throws WinstarcloudException {
        ...
        try {
            ...
            if (!result.isSuccessful()) {
                throw new WinstarcloudException(WinstarcloudErrorCode.ITEM_NOT_FOUND);
            }
    ...
    @Override
    public AlarmInfo ack(Alarm alarm, User user) throws WinstarcloudException {
        return ack(alarm, System.currentTimeMillis(), user);
    }

    @Override
    public AlarmInfo ack(Alarm alarm, long ackTs, User user) throws WinstarcloudException {
        ...
        if (result.isModified()) {
            ...
            throw new WinstarcloudException("Alarm was already acknowledged!", WinstarcloudErrorCode.BAD_REQUEST_PARAMS);
        }
        return alarmInfo;
    }

    @Override
    public AlarmInfo clear(Alarm alarm, User user) throws WinstarcloudException {
        return clear(alarm, System.currentTimeMillis(), user);
    }

    @Override
    public AlarmInfo clear(Alarm alarm, long clearTs, User user) throws WinstarcloudException {
        ...
        if (result.isCleared()) {
            ...
            throw new WinstarcloudException("Alarm was already cleared!", WinstarcloudErrorCode.BAD_REQUEST_PARAMS);
        }
        return alarmInfo;
    }

    @Override
    public AlarmInfo assign(Alarm alarm, UserId assigneeId, long assignTs, User user) throws WinstarcloudException {
        ...
        if (result.isModified()) {
            ...
            throw new WinstarcloudException("Alarm was already assigned to this user!", WinstarcloudErrorCode.BAD_REQUEST_PARAMS);
        }
        return alarmInfo;
    }

    @Override
    public AlarmInfo unassign(Alarm alarm, long unassignTs, User user) throws WinstarcloudException {
        ...
        if (result.isModified()) {
            ...
            throw new WinstarcloudException("Alarm was already unassigned!", WinstarcloudErrorCode.BAD_REQUEST_PARAMS);
        }
        return alarmInfo;
    }
