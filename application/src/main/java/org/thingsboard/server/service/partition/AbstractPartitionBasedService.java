...
public abstract class AbstractPartitionBasedService<T extends EntityId> extends TbApplicationEventListener<PartitionChangeEvent> {
    ...
    protected void init() {
        ...
        scheduledExecutor = MoreExecutors.listeningDecorator(Executors.newSingleThreadScheduledExecutor(WinstarCloudThreadFactory.forName(getSchedulerExecutorName())));
    }
