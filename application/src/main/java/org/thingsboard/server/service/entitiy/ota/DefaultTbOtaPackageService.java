...
public class DefaultTbOtaPackageService extends AbstractTbEntityService implements TbOtaPackageService {
    ...
    @Override
    public OtaPackageInfo save(SaveOtaPackageInfoRequest saveOtaPackageInfoRequest, User user) throws WinstarcloudException {
    ...
    @Override
    public void delete(OtaPackageInfo otaPackageInfo, User user) throws WinstarcloudException {
