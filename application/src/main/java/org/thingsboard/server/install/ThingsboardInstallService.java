 ...
 */
package org.winstarcloud.server.install;
...
import org.winstarcloud.server.service.install.DatabaseEntitiesUpgradeService;
import org.winstarcloud.server.service.install.EntityDatabaseSchemaService;
import org.winstarcloud.server.service.install.InstallScripts;
import org.winstarcloud.server.service.install.NoSqlKeyspaceService;
import org.winstarcloud.server.service.install.SystemDataLoaderService;
import org.winstarcloud.server.service.install.TsDatabaseSchemaService;
import org.winstarcloud.server.service.install.TsLatestDatabaseSchemaService;
import org.winstarcloud.server.service.install.migrate.TsLatestMigrateService;
import org.winstarcloud.server.service.install.update.CacheCleanupService;
import org.winstarcloud.server.service.install.update.DataUpdateService;

import static org.winstarcloud.server.service.install.update.DefaultDataUpdateService.getEnv;

@Service
@Profile("install")
@Slf4j
public class WinstarcloudInstallService {
    ...
    public void performInstall() {
        try {
            if (isUpgrade) {
                log.info("Starting WinstarCloud Upgrade from version {} ...", upgradeFromVersion);

                cacheCleanupService.clearCache(upgradeFromVersion);

                if ("cassandra-latest-to-postgres".equals(upgradeFromVersion)) {
                    log.info("Migrating WinstarCloud latest timeseries data from cassandra to SQL database ...");
                    ...
                    switch (upgradeFromVersion) {
                        case "3.5.0":
                            log.info("Upgrading WinstarCloud from version 3.5.0 to 3.5.1 ...");
                            databaseEntitiesUpgradeService.upgradeDatabase("3.5.0");
                        case "3.5.1":
                            log.info("Upgrading WinstarCloud from version 3.5.1 to 3.6.0 ...");
                        ...
                        case "3.6.0":
                            log.info("Upgrading WinstarCloud from version 3.6.0 to 3.6.1 ...");
                            databaseEntitiesUpgradeService.upgradeDatabase("3.6.0");
                            dataUpdateService.updateData("3.6.0");
                        case "3.6.1":
                            log.info("Upgrading WinstarCloud from version 3.6.1 to 3.6.2 ...");
                        ...
                        case "3.6.2":
                            log.info("Upgrading WinstarCloud from version 3.6.2 to 3.6.3 ...");
                            databaseEntitiesUpgradeService.upgradeDatabase("3.6.2");
                            systemDataLoaderService.updateDefaultNotificationConfigs(true);
                        case "3.6.3":
                            log.info("Upgrading WinstarCloud from version 3.6.3 to 3.6.4 ...");
                            databaseEntitiesUpgradeService.upgradeDatabase("3.6.3");
                        case "3.6.4":
                            log.info("Upgrading WinstarCloud from version 3.6.4 to 3.7.0 ...");
                        ...
                        case "3.7.0":
                            log.info("Upgrading WinstarCloud from version 3.7.0 to 3.7.1 ...");
                            databaseEntitiesUpgradeService.upgradeDatabase("3.7.0");
                            //TODO DON'T FORGET to update switch statement in the CacheCleanupService if you need to clear the cache
                            break;
                        default:
                            throw new RuntimeException("Unable to upgrade WinstarCloud, unsupported fromVersion: " + upgradeFromVersion);
                    }
                ...
                log.info("Starting WinstarCloud Installation...");
...
//                systemDataLoaderService.loadSystemRules();
            ...
            log.error("Unexpected error during WinstarCloud installation!", e);
            throw new WinstarcloudInstallException("Unexpected error during WinstarCloud installation!", e);
        } finally {
