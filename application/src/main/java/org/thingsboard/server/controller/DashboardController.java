...
import org.winstarcloud.server.common.data.HomeDashboard;
import org.winstarcloud.server.common.data.HomeDashboardInfo;
...
import org.winstarcloud.server.service.entitiy.dashboard.TbDashboardService;
...
import static org.winstarcloud.server.controller.ControllerConstants.DASHBOARD_TEXT_SEARCH_DESCRIPTION;
...
import static org.winstarcloud.server.controller.ControllerConstants.INLINE_IMAGES;
import static org.winstarcloud.server.controller.ControllerConstants.INLINE_IMAGES_DESCRIPTION;
...
public class DashboardController extends BaseController {
    ...
    public long getServerTime() throws WinstarcloudException {
    ...
    public long getMaxDatapointsLimit() throws WinstarcloudException {
    ...
    public DashboardInfo getDashboardInfoById(
            ...
            @PathVariable(DASHBOARD_ID) String strDashboardId) throws WinstarcloudException {
    ...
    public Dashboard getDashboardById(
            ...
            @RequestParam(value = INLINE_IMAGES, required = false) boolean inlineImages) throws WinstarcloudException {
        checkParameter(DASHBOARD_ID, strDashboardId);
        DashboardId dashboardId = new DashboardId(toUUID(strDashboardId));
    ...
    public Dashboard updateDashboardCustomers(
            ...
            @RequestBody(required = false) String[] strCustomerIds) throws WinstarcloudException {
        checkParameter(DASHBOARD_ID, strDashboardId);
        DashboardId dashboardId = new DashboardId(toUUID(strDashboardId));
        Dashboard dashboard = checkDashboardId(dashboardId, Operation.ASSIGN_TO_CUSTOMER);
    ...
    public Dashboard addDashboardCustomers(
            ...
            @RequestBody String[] strCustomerIds) throws WinstarcloudException {
        checkParameter(DASHBOARD_ID, strDashboardId);
        DashboardId dashboardId = new DashboardId(toUUID(strDashboardId));
        Dashboard dashboard = checkDashboardId(dashboardId, Operation.ASSIGN_TO_CUSTOMER);
        Set<CustomerId> customerIds = customerIdFromStr(strCustomerIds);
    ...
    @ResponseBody
    public HomeDashboard getHomeDashboard() throws WinstarcloudException {
    ...
    @ResponseBody
    public HomeDashboardInfo getHomeDashboardInfo() throws WinstarcloudException {
        SecurityUser securityUser = getCurrentUser();
        if (securityUser.isSystemAdmin()) {
            return null;
        }
    ...
    @ResponseBody
    public HomeDashboardInfo getTenantHomeDashboardInfo() throws WinstarcloudException {
    ...
    public void setTenantHomeDashboardInfo(
            ...
            @RequestBody HomeDashboardInfo homeDashboardInfo) throws WinstarcloudException {
