...
import org.winstarcloud.server.common.data.UserEmailInfo;
...
import org.winstarcloud.server.common.data.query.EntityDataPageLink;
...
import org.winstarcloud.server.common.data.query.EntityTypeFilter;
import org.winstarcloud.server.common.data.query.TsValue;
...
import org.winstarcloud.server.common.data.settings.UserDashboardAction;
import org.winstarcloud.server.common.data.settings.UserDashboardsInfo;
...
import org.winstarcloud.server.service.entitiy.user.TbUserService;
import org.winstarcloud.server.service.query.EntityQueryService;
...
import static org.winstarcloud.server.controller.ControllerConstants.DASHBOARD_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.DEFAULT_DASHBOARD;
import static org.winstarcloud.server.controller.ControllerConstants.HOME_DASHBOARD;
...
import static org.winstarcloud.server.controller.ControllerConstants.SYSTEM_OR_TENANT_AUTHORITY_PARAGRAPH;
...
import static org.winstarcloud.server.controller.ControllerConstants.USER_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.USER_TEXT_SEARCH_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.UUID_WIKI_LINK;
import static org.winstarcloud.server.dao.entity.BaseEntityService.NULL_CUSTOMER_ID;
...
public class UserController extends BaseController {
    ...
    public User getUserById(
            ...
            @PathVariable(USER_ID) String strUserId) throws WinstarcloudException {
    ...
    public User saveUser(
            ...
            @RequestParam(required = false, defaultValue = "true") boolean sendActivationMail, HttpServletRequest request) throws WinstarcloudException {
    ...
    public void sendActivationEmail(
        ...
        if (!userCredentials.isEnabled() && userCredentials.getActivateToken() != null) {
            ...
            throw new WinstarcloudException("User is already activated!", WinstarcloudErrorCode.BAD_REQUEST_PARAMS);
        }
    }
    ...
    public void deleteUser(
        ...
        if (user.getAuthority() == Authority.SYS_ADMIN && getCurrentUser().getId().equals(userId)) {
            throw new WinstarcloudException("Sysadmin is not allowed to delete himself", WinstarcloudErrorCode.PERMISSION_DENIED);
        }
    ...
    public void setUserCredentialsEnabled(
            ...
            @RequestParam(required = false, defaultValue = "true") boolean userCredentialsEnabled) throws WinstarcloudException {
        checkParameter(USER_ID, strUserId);
        UserId userId = new UserId(toUUID(strUserId));
    ...
    public JsonNode saveUserSettings(@RequestBody JsonNode settings) throws WinstarcloudException {
        SecurityUser currentUser = getCurrentUser();
    ...
    public void putUserSettings(@RequestBody JsonNode settings) throws WinstarcloudException {
        SecurityUser currentUser = getCurrentUser();
    ...
    public JsonNode getUserSettings() throws WinstarcloudException {
        SecurityUser currentUser = getCurrentUser();
    ...
    public void deleteUserSettings(@Parameter(description = PATHS)
                                   @PathVariable(PATHS) String paths) throws WinstarcloudException {
    ...
    public void putUserSettings(@Parameter(description = "Settings type, case insensitive, one of: \"general\", \"quick_links\", \"doc_links\" or \"dashboards\".")
                                @PathVariable("type") String strType, @RequestBody JsonNode settings) throws WinstarcloudException {
        SecurityUser currentUser = getCurrentUser();
    ...
    public JsonNode getUserSettings(@Parameter(description = "Settings type, case insensitive, one of: \"general\", \"quick_links\", \"doc_links\" or \"dashboards\".")
                                    @PathVariable("type") String strType) throws WinstarcloudException {
        SecurityUser currentUser = getCurrentUser();
        UserSettingsType type = checkEnumParameter("Settings type", strType, UserSettingsType::valueOf);
        checkNotReserved(strType, type);
    ...
    public UserDashboardsInfo getUserDashboardsInfo() throws WinstarcloudException {
        SecurityUser currentUser = getCurrentUser();
    ...
    public UserDashboardsInfo reportUserDashboardAction(
            ...
            @PathVariable("action") String strAction) throws WinstarcloudException {
    ...
    private void checkNotReserved(String strType, UserSettingsType type) throws WinstarcloudException {
        if (type.isReserved()) {
            throw new WinstarcloudException("Settings with type: " + strType + " are reserved for internal use!", WinstarcloudErrorCode.BAD_REQUEST_PARAMS);
        }
    }
