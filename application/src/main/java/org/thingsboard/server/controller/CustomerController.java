...
import org.winstarcloud.server.service.entitiy.customer.TbCustomerService;
...
import static org.winstarcloud.server.controller.ControllerConstants.CUSTOMER_TEXT_SEARCH_DESCRIPTION;
...
public class CustomerController extends BaseController {
    ...
    public Customer getCustomerById(
            ...
            @PathVariable(CUSTOMER_ID) String strCustomerId) throws WinstarcloudException {
    ...
    public Customer getTenantCustomer(
            ...
            @RequestParam String customerTitle) throws WinstarcloudException {
            TenantId tenantId = getCurrentUser().getTenantId();
