...
import org.winstarcloud.server.service.entitiy.device.profile.TbDeviceProfileService;
...
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_PROFILE_DATA;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_PROFILE_ID;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_PROFILE_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_PROFILE_INFO_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_PROFILE_TEXT_SEARCH_DESCRIPTION;
...
public class DeviceProfileController extends BaseController {
    ...
    public DeviceProfileInfo getDeviceProfileInfoById(
            @Parameter(description = DEVICE_PROFILE_ID_PARAM_DESCRIPTION)
            @PathVariable(DEVICE_PROFILE_ID) String strDeviceProfileId) throws WinstarcloudException {
        checkParameter(DEVICE_PROFILE_ID, strDeviceProfileId);
        DeviceProfileId deviceProfileId = new DeviceProfileId(toUUID(strDeviceProfileId));
    ...
    @ResponseBody
    public DeviceProfileInfo getDefaultDeviceProfileInfo() throws WinstarcloudException {
    ...
    public List<String> getTimeseriesKeys(
            @Parameter(description = DEVICE_PROFILE_ID_PARAM_DESCRIPTION)
            @RequestParam(name = DEVICE_PROFILE_ID, required = false) String deviceProfileIdStr) throws WinstarcloudException {
    ...
    public PageData<DeviceProfileInfo> getDeviceProfileInfos(
            ...
            @RequestParam(required = false) String transportType) throws WinstarcloudException {
        PageLink pageLink = createPageLink(pageSize, page, textSearch, sortProperty, sortOrder);
    ...
    public List<EntityInfo> getDeviceProfileNames(
            ...
            @RequestParam(value = "activeOnly", required = false, defaultValue = "false") boolean activeOnly) throws WinstarcloudException {
