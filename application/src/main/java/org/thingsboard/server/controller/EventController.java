...
import static org.winstarcloud.server.controller.ControllerConstants.ENTITY_ID;
import static org.winstarcloud.server.controller.ControllerConstants.ENTITY_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.ENTITY_TYPE;
import static org.winstarcloud.server.controller.ControllerConstants.ENTITY_TYPE_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.EVENT_DEBUG_RULE_CHAIN_FILTER_OBJ;
import static org.winstarcloud.server.controller.ControllerConstants.EVENT_DEBUG_RULE_NODE_FILTER_OBJ;
import static org.winstarcloud.server.controller.ControllerConstants.EVENT_END_TIME_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.EVENT_ERROR_FILTER_OBJ;
import static org.winstarcloud.server.controller.ControllerConstants.EVENT_LC_EVENT_FILTER_OBJ;
import static org.winstarcloud.server.controller.ControllerConstants.EVENT_START_TIME_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.EVENT_STATS_FILTER_OBJ;
import static org.winstarcloud.server.controller.ControllerConstants.EVENT_TEXT_SEARCH_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.NEW_LINE;
...
public class EventController extends BaseController {
    ...
    public void clearEvents(@Parameter(description = ENTITY_TYPE_PARAM_DESCRIPTION, required = true)
                            ...
                            @RequestBody EventFilter eventFilter) throws WinstarcloudException {
        checkParameter("EntityId", strEntityId);
        checkParameter("EntityType", strEntityType);
        EntityId entityId = EntityIdFactory.getByTypeAndId(strEntityType, strEntityId);
    ...
    private static EventType resolveEventType(String eventType) throws WinstarcloudException {
        for (var et : EventType.values()) {
            if (et.name().equalsIgnoreCase(eventType) || et.getOldName().equalsIgnoreCase(eventType)) {
                return et;
            }
        }
        throw new WinstarcloudException("Event type: '" + eventType + "' is not supported!", WinstarcloudErrorCode.BAD_REQUEST_PARAMS);
    }
