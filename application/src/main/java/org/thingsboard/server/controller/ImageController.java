...
import org.winstarcloud.server.common.data.ImageDescriptor;
...
import org.winstarcloud.server.common.data.util.ThrowingSupplier;
import org.winstarcloud.server.dao.resource.ImageCacheKey;
import org.winstarcloud.server.dao.resource.ImageService;
import org.winstarcloud.server.dao.service.validator.ResourceDataValidator;
...
import static org.winstarcloud.server.controller.ControllerConstants.RESOURCE_INCLUDE_SYSTEM_IMAGES_DESCRIPTION;
...
public class ImageController extends BaseController {
    ...
    public TbResourceInfo updateImageInfo(@Parameter(description = IMAGE_TYPE_PARAM_DESCRIPTION, schema = @Schema(allowableValues = {"tenant", "system"}), required = true)
                                          ...
                                          @Parameter(description = IMAGE_KEY_PARAM_DESCRIPTION, required = true)
                                          @PathVariable String key,
                                          @RequestBody TbResourceInfo request) throws WinstarcloudException {
        TbResourceInfo imageInfo = checkImageInfo(type, key, Operation.WRITE);
    ...
    public TbResourceInfo updateImagePublicStatus(@Parameter(description = IMAGE_TYPE_PARAM_DESCRIPTION, schema = @Schema(allowableValues = {"tenant", "system"}), required = true)
                                                  ...
                                                  @Parameter(description = IMAGE_KEY_PARAM_DESCRIPTION, required = true)
                                                  @PathVariable String key,
                                                  @PathVariable boolean isPublic) throws WinstarcloudException {
        TbResourceInfo imageInfo = checkImageInfo(type, key, Operation.WRITE);
        TbResourceInfo newImageInfo = new TbResourceInfo(imageInfo);
    ...
    public TbResourceInfo getImageInfo(@Parameter(description = IMAGE_TYPE_PARAM_DESCRIPTION, schema = @Schema(allowableValues = {"tenant", "system"}), required = true)
                                       @PathVariable String type,
                                       @Parameter(description = IMAGE_KEY_PARAM_DESCRIPTION, required = true)
                                       @PathVariable String key) throws WinstarcloudException {
    ...
    public ResponseEntity<TbImageDeleteResult> deleteImage(@Parameter(description = IMAGE_TYPE_PARAM_DESCRIPTION, schema = @Schema(allowableValues = {"tenant", "system"}), required = true)
                                                           ...
                                                           @Parameter(description = IMAGE_KEY_PARAM_DESCRIPTION, required = true)
                                                           @PathVariable String key,
                                                           @RequestParam(name = "force", required = false) boolean force) throws WinstarcloudException {
    ...
    private TbResourceInfo checkImageInfo(String imageType, String key, Operation operation) throws WinstarcloudException {
    ...
    private TenantId getTenantId(String imageType) throws WinstarcloudException {
        TenantId tenantId;
