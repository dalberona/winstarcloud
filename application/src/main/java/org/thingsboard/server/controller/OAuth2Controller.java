...
import org.winstarcloud.server.utils.MiscUtils;
...
public class OAuth2Controller extends BaseController {
    ...
    public List<OAuth2ClientInfo> getOAuth2Clients(HttpServletRequest request,
                                                   ...
                                                   @RequestParam(required = false) String platform) throws WinstarcloudException {
    ...
    @ResponseBody
    public OAuth2Info getCurrentOAuth2Info() throws WinstarcloudException {
    ...
    public OAuth2Info saveOAuth2Info(@RequestBody OAuth2Info oauth2Info) throws WinstarcloudException {
    ...
    @ResponseBody
    public String getLoginProcessingUrl() throws WinstarcloudException {
        accessControlService.checkPermission(getCurrentUser(), Resource.OAUTH2_CONFIGURATION_INFO, Operation.READ);
