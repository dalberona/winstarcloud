...
import org.winstarcloud.server.common.data.security.model.JwtSettings;
...
import org.winstarcloud.server.common.data.sync.vc.AutoCommitSettings;
import org.winstarcloud.server.common.data.sync.vc.RepositorySettings;
import org.winstarcloud.server.common.data.sync.vc.RepositorySettingsInfo;
import org.winstarcloud.server.common.data.sync.vc.VcUtils;
...
import org.winstarcloud.server.service.security.auth.oauth2.CookieUtils;
...
import org.winstarcloud.server.service.system.SystemInfoService;
import org.winstarcloud.server.service.update.UpdateService;
...
public class AdminController extends BaseController {
    ...
    public AdminSettings getAdminSettings(
            ...
            @PathVariable("key") String key) throws WinstarcloudException {
    ...
    public AdminSettings saveAdminSettings(
            ...
            @RequestBody AdminSettings adminSettings) throws WinstarcloudException {
    ...
    @ResponseBody
    public SecuritySettings getSecuritySettings() throws WinstarcloudException {
        accessControlService.checkPermission(getCurrentUser(), Resource.ADMIN_SETTINGS, Operation.READ);
    ...
    public SecuritySettings saveSecuritySettings(
            ...
            @RequestBody SecuritySettings securitySettings) throws WinstarcloudException {
        accessControlService.checkPermission(getCurrentUser(), Resource.ADMIN_SETTINGS, Operation.WRITE);
    ...
    @ResponseBody
    public JwtSettings getJwtSettings() throws WinstarcloudException {
        accessControlService.checkPermission(getCurrentUser(), Resource.ADMIN_SETTINGS, Operation.READ);
    ...
    public JwtPair saveJwtSettings(
            ...
            @RequestBody JwtSettings jwtSettings) throws WinstarcloudException {
        ...
        if (adminSettings.getKey().equals("mail")) {
            if (adminSettings.getJsonValue().has("enableOauth2") && adminSettings.getJsonValue().get("enableOauth2").asBoolean()) {
                ...
                if (refreshToken == null) {
                    throw new WinstarcloudException("Refresh token was not generated. Please, generate refresh token.", WinstarcloudErrorCode.GENERAL);
                }
    ...
    public void sendTestSms(
            ...
            @RequestBody TestSmsRequest testSmsRequest) throws WinstarcloudException {
    ...
    public RepositorySettings getRepositorySettings() throws WinstarcloudException {
    ...
    public Boolean repositorySettingsExists() throws WinstarcloudException {
        accessControlService.checkPermission(getCurrentUser(), Resource.VERSION_CONTROL, Operation.READ);
    ...
    public DeferredResult<RepositorySettings> saveRepositorySettings(@RequestBody RepositorySettings settings) throws WinstarcloudException {
    ...
    public AutoCommitSettings getAutoCommitSettings() throws WinstarcloudException {
        accessControlService.checkPermission(getCurrentUser(), Resource.VERSION_CONTROL, Operation.READ);
    ...
    public Boolean autoCommitSettingsExists() throws WinstarcloudException {
        accessControlService.checkPermission(getCurrentUser(), Resource.VERSION_CONTROL, Operation.READ);
    ...
    public AutoCommitSettings saveAutoCommitSettings(@RequestBody AutoCommitSettings settings) throws WinstarcloudException {
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public void deleteAutoCommitSettings() throws WinstarcloudException {
        accessControlService.checkPermission(getCurrentUser(), Resource.VERSION_CONTROL, Operation.DELETE);
    ...
    @ResponseBody
    public UpdateMessage checkUpdates() throws WinstarcloudException {
    ...
    @ResponseBody
    public SystemInfo getSystemInfo() throws WinstarcloudException {
    ...
    @ResponseBody
    public String getMailProcessingUrl() throws WinstarcloudException {
        accessControlService.checkPermission(getCurrentUser(), Resource.ADMIN_SETTINGS, Operation.READ);
    ...
    public String getAuthorizationUrl(HttpServletRequest request, HttpServletResponse response) throws WinstarcloudException {
    ...
    public void codeProcessingUrl(
            ...
            HttpServletRequest request, HttpServletResponse response) throws WinstarcloudException, IOException {
        ...
        if (cookieState.isEmpty() || !cookieState.get().getValue().equals(state)) {
            ...
            throw new WinstarcloudException("Refresh token was not generated, invalid state param", WinstarcloudErrorCode.BAD_REQUEST_PARAMS);
        }
        CookieUtils.deleteCookie(request, response, STATE_COOKIE_NAME);
        ...
        try {
            ...
            throw new WinstarcloudException("Error while requesting access token: " + e.getMessage(), WinstarcloudErrorCode.GENERAL);
        }
