...
import org.winstarcloud.server.common.data.asset.AssetSearchQuery;
...
import org.winstarcloud.server.service.asset.AssetBulkImportService;
import org.winstarcloud.server.service.entitiy.asset.TbAssetService;
...
import static org.winstarcloud.server.controller.ControllerConstants.ASSET_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.ASSET_INFO_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.ASSET_NAME_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.ASSET_PROFILE_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.ASSET_TEXT_SEARCH_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.ASSET_TYPE_DESCRIPTION;
...
public class AssetController extends BaseController {
    ...
    public Asset getAssetById(@Parameter(description = ASSET_ID_PARAM_DESCRIPTION)
                              @PathVariable(ASSET_ID) String strAssetId) throws WinstarcloudException {
    ...
    public Asset assignAssetToCustomer(@Parameter(description = CUSTOMER_ID_PARAM_DESCRIPTION) @PathVariable("customerId") String strCustomerId,
                                       @Parameter(description = ASSET_ID_PARAM_DESCRIPTION) @PathVariable(ASSET_ID) String strAssetId) throws WinstarcloudException {
    ...
    @ResponseBody
    public Asset unassignAssetFromCustomer(@Parameter(description = ASSET_ID_PARAM_DESCRIPTION) @PathVariable(ASSET_ID) String strAssetId) throws WinstarcloudException {
        checkParameter(ASSET_ID, strAssetId);
        AssetId assetId = new AssetId(toUUID(strAssetId));
    ...
    @ResponseBody
    public Asset assignAssetToPublicCustomer(@Parameter(description = ASSET_ID_PARAM_DESCRIPTION) @PathVariable(ASSET_ID) String strAssetId) throws WinstarcloudException {
        checkParameter(ASSET_ID, strAssetId);
        AssetId assetId = new AssetId(toUUID(strAssetId));
        checkAssetId(assetId, Operation.ASSIGN_TO_CUSTOMER);
    ...
    public Asset getTenantAsset(
            ...
            @RequestParam String assetName) throws WinstarcloudException {
        TenantId tenantId = getCurrentUser().getTenantId();
    ...
    public List<Asset> getAssetsByIds(
            ...
            @RequestParam("assetIds") String[] strAssetIds) throws WinstarcloudException, ExecutionException, InterruptedException {
    ...
    @ResponseBody
    public List<Asset> findByQuery(@RequestBody AssetSearchQuery query) throws WinstarcloudException, ExecutionException, InterruptedException {
        checkNotNull(query);
    ...
    public List<EntitySubtype> getAssetTypes() throws WinstarcloudException, ExecutionException, InterruptedException {
        SecurityUser user = getCurrentUser();
        TenantId tenantId = user.getTenantId();
