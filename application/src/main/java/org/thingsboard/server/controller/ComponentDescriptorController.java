...
public class ComponentDescriptorController extends BaseController {
    ...
    public ComponentDescriptor getComponentDescriptorByClazz(
            ...
            @PathVariable("componentDescriptorClazz") String strComponentDescriptorClazz) throws WinstarcloudException {
    ...
    public List<ComponentDescriptor> getComponentDescriptorsByType(
            ...
            @RequestParam(value = "ruleChainType", required = false) String strRuleChainType) throws WinstarcloudException {
