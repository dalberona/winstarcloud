...
import static org.winstarcloud.server.controller.ControllerConstants.ALARM_DATA_QUERY_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.ATTRIBUTES_SCOPE_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.ENTITY_COUNT_QUERY_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.ENTITY_DATA_QUERY_DESCRIPTION;
...
public class EntityQueryController extends BaseController {
    ...
    public long countEntitiesByQuery(
            ...
            @RequestBody EntityCountQuery query) throws WinstarcloudException {
        checkNotNull(query);
    ...
    public PageData<EntityData> findEntityDataByQuery(
            ...
            @RequestBody EntityDataQuery query) throws WinstarcloudException {
        checkNotNull(query);
    ...
    public PageData<AlarmData> findAlarmDataByQuery(
            ...
            @RequestBody AlarmDataQuery query) throws WinstarcloudException {
        checkNotNull(query);
    ...
    public long countAlarmsByQuery(@Parameter(description = "A JSON value representing the alarm count query.")
                                   @RequestBody AlarmCountQuery query) throws WinstarcloudException {
        checkNotNull(query);
    ...
    public DeferredResult<ResponseEntity> findEntityTimeseriesAndAttributesKeysByQuery(
            ...
            @RequestParam(value = "scope", required = false) String scope) throws WinstarcloudException {
