...
import org.winstarcloud.server.common.data.notification.targets.NotificationTargetConfig;
...
import org.winstarcloud.server.common.data.notification.targets.platform.TenantAdministratorsFilter;
...
public class NotificationTargetController extends BaseController {
    ...
    @PreAuthorize("hasAnyAuthority('SYS_ADMIN', 'TENANT_ADMIN')")
    public NotificationTarget getNotificationTargetById(@PathVariable UUID id) throws WinstarcloudException {
    ...
    private void checkTargetUsers(SecurityUser user, NotificationTargetConfig targetConfig) throws WinstarcloudException {
