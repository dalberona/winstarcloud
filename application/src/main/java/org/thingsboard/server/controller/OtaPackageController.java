...
import org.winstarcloud.server.service.entitiy.ota.TbOtaPackageService;
...
import static org.winstarcloud.server.controller.ControllerConstants.OTA_PACKAGE_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.OTA_PACKAGE_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.OTA_PACKAGE_INFO_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.OTA_PACKAGE_TEXT_SEARCH_DESCRIPTION;
...
public class OtaPackageController extends BaseController {
    ...
    public ResponseEntity<org.springframework.core.io.Resource> downloadOtaPackage(@Parameter(description = OTA_PACKAGE_ID_PARAM_DESCRIPTION)
                                                                                   @PathVariable(OTA_PACKAGE_ID) String strOtaPackageId) throws WinstarcloudException {
    ...
    public OtaPackageInfo saveOtaPackageInfo(@Parameter(description = "A JSON value representing the OTA Package.")
                                             @RequestBody SaveOtaPackageInfoRequest otaPackageInfo) throws WinstarcloudException {
    ...
    public OtaPackageInfo saveOtaPackageData(@Parameter(description = OTA_PACKAGE_ID_PARAM_DESCRIPTION)
                                             ...
                                             @RequestPart MultipartFile file) throws WinstarcloudException, IOException {
        checkParameter(OTA_PACKAGE_ID, strOtaPackageId);
    ...
    public void deleteOtaPackage(@Parameter(description = OTA_PACKAGE_ID_PARAM_DESCRIPTION)
                                 @PathVariable("otaPackageId") String strOtaPackageId) throws WinstarcloudException {
        checkParameter(OTA_PACKAGE_ID, strOtaPackageId);
        OtaPackageId otaPackageId = new OtaPackageId(toUUID(strOtaPackageId));
