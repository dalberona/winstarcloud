...
import static org.winstarcloud.server.controller.ControllerConstants.QUEUE_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.QUEUE_NAME_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.QUEUE_QUEUE_TEXT_SEARCH_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.QUEUE_SERVICE_TYPE_DESCRIPTION;
...
public class QueueController extends BaseController {
    ...
    public Queue getQueueById(@Parameter(description = QUEUE_ID_PARAM_DESCRIPTION)
                              @PathVariable("queueId") String queueIdStr) throws WinstarcloudException {
    ...
    public Queue getQueueByName(@Parameter(description = QUEUE_NAME_PARAM_DESCRIPTION)
                                @PathVariable("queueName") String queueName) throws WinstarcloudException {
    ...
    public Queue saveQueue(@Parameter(description = "A JSON value representing the queue.")
                           ...
                           @RequestParam String serviceType) throws WinstarcloudException {
        checkParameter("serviceType", serviceType);
