...
import org.winstarcloud.server.service.resource.TbResourceService;
...
import static org.winstarcloud.server.controller.ControllerConstants.LWM2M_OBJECT_DESCRIPTION;
...
import static org.winstarcloud.server.controller.ControllerConstants.RESOURCE_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.RESOURCE_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.RESOURCE_INFO_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.RESOURCE_TEXT_SEARCH_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.RESOURCE_TYPE;
...
public class TbResourceController extends BaseController {
    ...
    public ResponseEntity<ByteArrayResource> downloadResource(@Parameter(description = RESOURCE_ID_PARAM_DESCRIPTION)
                                                              @PathVariable(RESOURCE_ID) String strResourceId) throws WinstarcloudException {
    ...
    public ResponseEntity<ByteArrayResource> downloadLwm2mResourceIfChanged(@Parameter(description = RESOURCE_ID_PARAM_DESCRIPTION)
                                                                            ...
                                                                            @RequestHeader(name = HttpHeaders.IF_NONE_MATCH, required = false) String etag) throws WinstarcloudException {
    ...
    public List<LwM2mObject> getLwm2mListObjects(@Parameter(description = SORT_ORDER_DESCRIPTION, schema = @Schema(allowableValues = {"ASC", "DESC"}, requiredMode = Schema.RequiredMode.REQUIRED))
                                                 ...
                                                 @RequestParam(required = false) String[] objectIds) throws WinstarcloudException {
    ...
    public void deleteResource(@Parameter(description = RESOURCE_ID_PARAM_DESCRIPTION)
                               @PathVariable("resourceId") String strResourceId) throws WinstarcloudException {
        checkParameter(RESOURCE_ID, strResourceId);
        TbResourceId resourceId = new TbResourceId(toUUID(strResourceId));
    ...
    private ResponseEntity<ByteArrayResource> downloadResourceIfChanged(ResourceType resourceType, String strResourceId, String etag) throws WinstarcloudException {
        checkParameter(RESOURCE_ID, strResourceId);
        TbResourceId resourceId = new TbResourceId(toUUID(strResourceId));
        if (etag != null) {
