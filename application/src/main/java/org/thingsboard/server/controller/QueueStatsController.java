...
import static org.winstarcloud.server.controller.ControllerConstants.QUEUE_STATS_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.QUEUE_STATS_TEXT_SEARCH_DESCRIPTION;
...
public class QueueStatsController extends BaseController {
    ...
    public QueueStats getQueueStatsById(@Parameter(description = QUEUE_STATS_ID_PARAM_DESCRIPTION)
                                        @PathVariable("queueStatsId") String queueStatsIdStr) throws WinstarcloudException {
    ...
    public List<QueueStats> getQueueStatsByIds(
            ...
            @RequestParam("queueStatsIds") String[] strQueueStatsIds) throws WinstarcloudException {
