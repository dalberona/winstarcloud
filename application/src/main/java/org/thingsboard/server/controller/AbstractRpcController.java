...
import org.winstarcloud.server.service.rpc.LocalRequestMetaData;
...
public abstract class AbstractRpcController extends BaseController {
    ...
    protected DeferredResult<ResponseEntity> handleDeviceRPCRequest(boolean oneWay, DeviceId deviceId, String requestBody, HttpStatus timeoutStatus, HttpStatus noActiveConnectionStatus) throws WinstarcloudException {
        try {
            ...
            throw new WinstarcloudException("Invalid request body", ioe, WinstarcloudErrorCode.BAD_REQUEST_PARAMS);
        }
    }
