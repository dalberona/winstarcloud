...
import static org.winstarcloud.server.controller.ControllerConstants.RPC_ID;
import static org.winstarcloud.server.controller.ControllerConstants.RPC_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.RPC_TEXT_SEARCH_DESCRIPTION;
...
public class RpcV2Controller extends AbstractRpcController {
    ...
    public DeferredResult<ResponseEntity> handleOneWayDeviceRPCRequest(
            ...
            @RequestBody String requestBody) throws WinstarcloudException {
    ...
    public Rpc getPersistedRpc(
            ...
            @PathVariable(RPC_ID) String strRpc) throws WinstarcloudException {
