...
import static org.winstarcloud.server.controller.ControllerConstants.TENANT_PROFILE_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.TENANT_PROFILE_TEXT_SEARCH_DESCRIPTION;
...
public class TenantProfileController extends BaseController {
    ...
    public TenantProfile getTenantProfileById(
            ...
            @PathVariable("tenantProfileId") String strTenantProfileId) throws WinstarcloudException {
    ...
    @ResponseBody
    public EntityInfo getDefaultTenantProfileInfo() throws WinstarcloudException {
    ...
    public TenantProfile saveTenantProfile(@Parameter(description = "A JSON value representing the tenant profile.")
                                           @RequestBody TenantProfile tenantProfile) throws WinstarcloudException {
