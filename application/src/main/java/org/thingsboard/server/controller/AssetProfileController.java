...
import org.winstarcloud.server.service.entitiy.asset.profile.TbAssetProfileService;
...
import static org.winstarcloud.server.controller.ControllerConstants.ASSET_PROFILE_ID;
import static org.winstarcloud.server.controller.ControllerConstants.ASSET_PROFILE_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.ASSET_PROFILE_INFO_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.ASSET_PROFILE_TEXT_SEARCH_DESCRIPTION;
...
public class AssetProfileController extends BaseController {
    ...
    public AssetProfileInfo getAssetProfileInfoById(
            @Parameter(description = ASSET_PROFILE_ID_PARAM_DESCRIPTION)
            @PathVariable(ASSET_PROFILE_ID) String strAssetProfileId) throws WinstarcloudException {
        checkParameter(ASSET_PROFILE_ID, strAssetProfileId);
        AssetProfileId assetProfileId = new AssetProfileId(toUUID(strAssetProfileId));
    ...
    @ResponseBody
    public AssetProfileInfo getDefaultAssetProfileInfo() throws WinstarcloudException {
