...
import org.winstarcloud.server.common.data.device.profile.lwm2m.bootstrap.LwM2MServerSecurityConfigDefault;
...
import org.winstarcloud.server.service.lwm2m.LwM2MService;

import java.util.Map;

import static org.winstarcloud.server.controller.ControllerConstants.IS_BOOTSTRAP_SERVER_PARAM_DESCRIPTION;
...
public class Lwm2mController extends BaseController {
    ...
    public LwM2MServerSecurityConfigDefault getLwm2mBootstrapSecurityInfo(
        ...
        @PathVariable(IS_BOOTSTRAP_SERVER) boolean bootstrapServer) throws WinstarcloudException {
    ...
    @ResponseBody
    public Device saveDeviceWithCredentials(@RequestBody Map<Class<?>, Object> deviceWithDeviceCredentials) throws WinstarcloudException {
