...
import org.winstarcloud.server.service.entitiy.widgets.bundle.TbWidgetsBundleService;
...
import static org.winstarcloud.server.controller.ControllerConstants.WIDGET_BUNDLE_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.WIDGET_BUNDLE_TEXT_SEARCH_DESCRIPTION;
...
public class WidgetsBundleController extends BaseController {
    ...
    public void deleteWidgetsBundle(
            @Parameter(description = WIDGET_BUNDLE_ID_PARAM_DESCRIPTION, required = true)
            @PathVariable("widgetsBundleId") String strWidgetsBundleId) throws WinstarcloudException {
        checkParameter("widgetsBundleId", strWidgetsBundleId);
        WidgetsBundleId widgetsBundleId = new WidgetsBundleId(toUUID(strWidgetsBundleId));
    ...
    public PageData<WidgetsBundle> getWidgetsBundles(
            ...
            @RequestParam(required = false) Boolean fullSearch) throws WinstarcloudException {
    ...
    @ResponseBody
    public List<WidgetsBundle> getWidgetsBundles() throws WinstarcloudException {
        if (Authority.SYS_ADMIN.equals(getCurrentUser().getAuthority())) {
