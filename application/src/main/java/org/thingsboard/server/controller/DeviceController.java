...
import org.winstarcloud.server.common.data.ClaimRequest;
...
import org.winstarcloud.server.common.data.DeviceInfoFilter;
...
import org.winstarcloud.server.common.data.sync.ie.importing.csv.BulkImportRequest;
import org.winstarcloud.server.common.data.sync.ie.importing.csv.BulkImportResult;
...
import org.winstarcloud.server.service.device.DeviceBulkImportService;
import org.winstarcloud.server.service.entitiy.device.TbDeviceService;
...
import static org.winstarcloud.server.controller.ControllerConstants.CUSTOMER_AUTHORITY_PARAGRAPH;
import static org.winstarcloud.server.controller.ControllerConstants.CUSTOMER_ID;
import static org.winstarcloud.server.controller.ControllerConstants.CUSTOMER_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_ACTIVE_PARAM_DESCRIPTION;
...
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_INFO_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_NAME_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_PROFILE_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_TEXT_SEARCH_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_TYPE_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_UPDATE_CREDENTIALS_PARAM_ACCESS_TOKEN_DESCRIPTION_MARKDOWN;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_UPDATE_CREDENTIALS_PARAM_LVM2M_RPK_DESCRIPTION_MARKDOWN;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_UPDATE_CREDENTIALS_PARAM_MQTT_BASIC_DESCRIPTION_MARKDOWN;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_UPDATE_CREDENTIALS_PARAM_X509_CERTIFICATE_DESCRIPTION_MARKDOWN;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_WITH_DEVICE_CREDENTIALS_PARAM_ACCESS_TOKEN_DEFAULT_DESCRIPTION_MARKDOWN;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_WITH_DEVICE_CREDENTIALS_PARAM_ACCESS_TOKEN_DESCRIPTION_MARKDOWN;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_WITH_DEVICE_CREDENTIALS_PARAM_LVM2M_RPK_DESCRIPTION_MARKDOWN;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_WITH_DEVICE_CREDENTIALS_PARAM_MQTT_BASIC_DESCRIPTION_MARKDOWN;
import static org.winstarcloud.server.controller.ControllerConstants.DEVICE_WITH_DEVICE_CREDENTIALS_PARAM_X509_CERTIFICATE_DESCRIPTION_MARKDOWN;
import static org.winstarcloud.server.controller.ControllerConstants.EDGE_ASSIGN_ASYNC_FIRST_STEP_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.EDGE_ASSIGN_RECEIVE_STEP_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.EDGE_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.EDGE_UNASSIGN_ASYNC_FIRST_STEP_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.EDGE_UNASSIGN_RECEIVE_STEP_DESCRIPTION;
...
import static org.winstarcloud.server.controller.ControllerConstants.TENANT_AUTHORITY_PARAGRAPH;
import static org.winstarcloud.server.controller.ControllerConstants.TENANT_ID;
import static org.winstarcloud.server.controller.ControllerConstants.TENANT_ID_PARAM_DESCRIPTION;
...
import static org.winstarcloud.server.controller.EdgeController.EDGE_ID;
...
public class DeviceController extends BaseController {
    ...
    public Device getDeviceById(@Parameter(description = DEVICE_ID_PARAM_DESCRIPTION)
                                @PathVariable(DEVICE_ID) String strDeviceId) throws WinstarcloudException {
    ...
    public Device saveDeviceWithCredentials(@Parameter(description = "The JSON object with device and credentials. See method description above for example.")
                                            @Valid @RequestBody SaveDeviceWithCredentialsRequest deviceAndCredentials) throws WinstarcloudException {
    ...
    public DeviceCredentials updateDeviceCredentials(
            ...
            @RequestBody DeviceCredentials deviceCredentials) throws WinstarcloudException {
    ...
    public PageData<Device> getTenantDevices(
            ...
            @RequestParam(required = false) String sortOrder) throws WinstarcloudException {
    ...
    public Device getTenantDevice(
            ...
            @RequestParam String deviceName) throws WinstarcloudException {
        TenantId tenantId = getCurrentUser().getTenantId();
    ...
    public List<Device> getDevicesByIds(
            ...
            @RequestParam("deviceIds") String[] strDeviceIds) throws WinstarcloudException, ExecutionException, InterruptedException {
    ...
    public List<Device> findByQuery(
            ...
            @RequestBody DeviceSearchQuery query) throws WinstarcloudException, ExecutionException, InterruptedException {
        checkNotNull(query);
    ...
    public List<EntitySubtype> getDeviceTypes() throws WinstarcloudException, ExecutionException, InterruptedException {
        SecurityUser user = getCurrentUser();
        TenantId tenantId = user.getTenantId();
    ...
    public DeferredResult<ResponseEntity> claimDevice(@Parameter(description = "Unique name of the device which is going to be claimed")
                                                      ...
                                                      @RequestBody(required = false) ClaimRequest claimRequest) throws WinstarcloudException {
    ...
    public DeferredResult<ResponseEntity> reClaimDevice(@Parameter(description = "Unique name of the device which is going to be reclaimed")
                                                        @PathVariable(DEVICE_NAME) String deviceName) throws WinstarcloudException {
        checkParameter(DEVICE_NAME, deviceName);
        final DeferredResult<ResponseEntity> deferredResult = new DeferredResult<>();
    ...
    public Device assignDeviceToTenant(@Parameter(description = TENANT_ID_PARAM_DESCRIPTION)
        ...
        if (newTenant == null) {
            throw new WinstarcloudException("Could not find the specified Tenant!", WinstarcloudErrorCode.BAD_REQUEST_PARAMS);
        }
    ...
    public PageData<DeviceInfo> getEdgeDevices(
            ...
            @RequestParam(required = false) Long endTime) throws WinstarcloudException {
        checkParameter(EDGE_ID, strEdgeId);
        TenantId tenantId = getCurrentUser().getTenantId();
        EdgeId edgeId = new EdgeId(toUUID(strEdgeId));
    ...
    public Long countByDeviceProfileAndEmptyOtaPackage(
            ...
            @PathVariable("deviceProfileId") String deviceProfileId) throws WinstarcloudException {
