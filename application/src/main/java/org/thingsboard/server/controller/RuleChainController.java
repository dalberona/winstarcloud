...
import org.winstarcloud.rule.engine.api.ScriptEngine;
import org.winstarcloud.script.api.js.JsInvokeService;
import org.winstarcloud.script.api.tbel.TbelInvokeService;
import org.winstarcloud.server.actors.ActorSystemContext;
import org.winstarcloud.server.actors.tenant.DebugTbRateLimits;
...
import org.winstarcloud.server.common.data.page.PageDataIterableByTenant;
...
import org.winstarcloud.server.common.data.script.ScriptLanguage;
...
import org.winstarcloud.server.dao.event.EventService;
import org.winstarcloud.server.queue.util.TbCoreComponent;
import org.winstarcloud.server.service.rule.TbRuleChainService;
import org.winstarcloud.server.service.script.RuleNodeJsScriptEngine;
import org.winstarcloud.server.service.script.RuleNodeTbelScriptEngine;
...
import static org.winstarcloud.server.controller.ControllerConstants.EDGE_ID;
...
import static org.winstarcloud.server.controller.ControllerConstants.RULE_CHAIN_ID_PARAM_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.RULE_CHAIN_TEXT_SEARCH_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.RULE_CHAIN_TYPE_DESCRIPTION;
import static org.winstarcloud.server.controller.ControllerConstants.RULE_NODE_ID_PARAM_DESCRIPTION;
...
public class RuleChainController extends BaseController {
    ...
    public RuleChain getRuleChainById(
            ...
            @PathVariable(RULE_CHAIN_ID) String strRuleChainId) throws WinstarcloudException {
    ...
    public JsonNode getLatestRuleNodeDebugInput(
            ...
            @PathVariable(RULE_NODE_ID) String strRuleNodeId) throws WinstarcloudException {
    ...
    public JsonNode testScript(
            ...
            @RequestBody JsonNode inputParams) throws WinstarcloudException, JsonProcessingException {
    ...
    public RuleChainData exportRuleChains(
            ...
            @RequestParam("limit") int limit) throws WinstarcloudException {
        TenantId tenantId = getCurrentUser().getTenantId();
    ...
    public List<RuleChainImportResult> importRuleChains(
            ...
            @RequestParam(required = false, defaultValue = "false") boolean overwrite) throws WinstarcloudException {
        TenantId tenantId = getCurrentUser().getTenantId();
    ...
    @ResponseBody
    public List<RuleChain> getAutoAssignToEdgeRuleChains() throws WinstarcloudException {
        TenantId tenantId = getCurrentUser().getTenantId();
