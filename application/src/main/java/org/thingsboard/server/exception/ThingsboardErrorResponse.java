...
@Schema
public class WinstarcloudErrorResponse {
    ...
    // Error code
    private final WinstarcloudErrorCode errorCode;

    private final long timestamp;

    protected WinstarcloudErrorResponse(final String message, final WinstarcloudErrorCode errorCode, HttpStatus status) {
    ...
    public static WinstarcloudErrorResponse of(final String message, final WinstarcloudErrorCode errorCode, HttpStatus status) {
        return new WinstarcloudErrorResponse(message, errorCode, status);
    }
