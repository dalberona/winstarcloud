 ...
 */
package org.winstarcloud.server.utils;
...
import org.winstarcloud.server.common.data.lwm2m.LwM2mInstance;
import org.winstarcloud.server.common.data.lwm2m.LwM2mObject;
import org.winstarcloud.server.common.data.lwm2m.LwM2mResourceObserve;
...
import static org.winstarcloud.server.common.data.lwm2m.LwM2mConstants.LWM2M_SEPARATOR_SEARCH_TEXT;
...
public class LwM2mObjectModelUtils {
    ...
    public static void toLwm2mResource(TbResource resource) throws WinstarcloudException {
        try {
            ...
            throw new WinstarcloudException(e, WinstarcloudErrorCode.GENERAL);
        }
