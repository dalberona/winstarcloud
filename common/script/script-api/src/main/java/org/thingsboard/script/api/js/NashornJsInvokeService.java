 ...
 */
package org.winstarcloud.script.api.js;
...
import org.winstarcloud.script.api.TbScriptException;
...
public class NashornJsInvokeService extends AbstractJsInvokeService {
    ...
    public void init() {
        super.init();
        jsExecutor = MoreExecutors.listeningDecorator(WinstarCloudExecutors.newWorkStealingPool(jsExecutorThreadPoolSize, "nashorn-js-executor"));
        if (useJsSandbox) {
            sandbox = NashornSandboxes.create();
            monitorExecutorService = WinstarCloudExecutors.newWorkStealingPool(monitorThreadPoolSize, "nashorn-js-monitor");
