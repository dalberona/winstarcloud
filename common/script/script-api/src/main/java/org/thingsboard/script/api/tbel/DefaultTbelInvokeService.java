 ...
 */
package org.winstarcloud.script.api.tbel;
...
import org.winstarcloud.script.api.AbstractScriptInvokeService;
import org.winstarcloud.script.api.ScriptType;
...
public class DefaultTbelInvokeService extends AbstractScriptInvokeService implements TbelInvokeService {
    ...
    public void init() {
        ...
        executor = MoreExecutors.listeningDecorator(WinstarCloudExecutors.newWorkStealingPool(threadPoolSize, "tbel-executor"));
        try {
