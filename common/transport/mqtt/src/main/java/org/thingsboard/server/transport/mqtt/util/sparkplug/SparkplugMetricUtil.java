 ...
 */
package org.winstarcloud.server.transport.mqtt.util.sparkplug;
...
import static org.winstarcloud.common.util.JacksonUtil.newArrayNode;
...
public class SparkplugMetricUtil {
    ...
    public static Optional<TransportProtos.KeyValueProto> fromSparkplugBMetricToKeyValueProto(String key, SparkplugBProto.Payload.Metric protoMetric) throws WinstarcloudException {
            ...
            switch (metricDataType) {
                ...
                case UInt64:
                    if (protoMetric.hasIntValue()) {
                        ...
                        throw new WinstarcloudException("Invalid value for " + MetricDataType.fromInteger(metricType).name() + " datatype " + metricType, WinstarcloudErrorCode.INVALID_ARGUMENTS);
                    }
                case String:
                case Text:
                case UUID:
                ...
                case Unknown:
                default:
                    throw new WinstarcloudException("Failed to decode: Unknown MetricDataType " + metricType, WinstarcloudErrorCode.INVALID_ARGUMENTS);
            }
        } catch (Exception e) {
            log.error("", e);
            return Optional.empty();
    ...
    public static SparkplugBProto.Payload.Metric createMetric(Object value, long ts, String key, MetricDataType metricDataType) throws WinstarcloudException {
        ...
        switch (metricDataType) {
            ...
            case Unknown:
                throw new WinstarcloudException("Invalid value for MetricDataType " + metricDataType.name(), WinstarcloudErrorCode.INVALID_ARGUMENTS);
        }
        return metric;
    }

    public static TransportProtos.TsKvProto getTsKvProto(String key, Object value, long ts) throws WinstarcloudException {
        try {
            ...
            if (value instanceof String) {
                ...
                throw new WinstarcloudException("Failed to convert device/node RPC command to TsKvProto for Sparkplug MQT msg: value [" + value + "]", WinstarcloudErrorCode.INVALID_ARGUMENTS);
            }
    ...
    public static Optional<Object> validatedValueByTypeMetric(TransportProtos.KeyValueProto kv, MetricDataType metricDataType) throws WinstarcloudException {
        if (kv.getTypeValue() <= 3) {
            ...
            throw new WinstarcloudException("Invalid type KeyValueProto " + kv.toString() + " for MetricDataType " + metricDataType.name(), WinstarcloudErrorCode.INVALID_ARGUMENTS);
        }
        return Optional.empty();
    }

    public static Optional<Object> validatedValuePrimitiveByTypeMetric(TransportProtos.KeyValueProto kv, MetricDataType metricDataType) throws WinstarcloudException {
        ...
        if (valueOpt.isPresent()) {
            try {
                switch (metricDataType) {
                    ...
                    case Int32:
                        ...
                        try {
                            ...
                            throw new WinstarcloudException("Invalid type value " + kv.toString() + " for MetricDataType "
                                    + metricDataType.name(), eInt, WinstarcloudErrorCode.INVALID_ARGUMENTS);
                        }
                        // long
                    case UInt32:
                    case Int64:
                ...
                throw new WinstarcloudException("Invalid type value " + kv.toString() + " for MetricDataType " + metricDataType.name(), e, WinstarcloudErrorCode.INVALID_ARGUMENTS);
            }
        }
        return Optional.empty();
    }
