...
import org.winstarcloud.server.common.transport.config.ssl.SslCredentialsConfig;
...
public class MqttSslHandlerProvider {
    ...
    private TrustManager getX509TrustManager(TrustManagerFactory tmf) throws Exception {
        ...
        return new WinstarcloudMqttX509TrustManager(x509Tm, transportService);
    }

    static class WinstarcloudMqttX509TrustManager implements X509TrustManager {

        private final X509TrustManager trustManager;
        private final TransportService transportService;

        WinstarcloudMqttX509TrustManager(X509TrustManager trustManager, TransportService transportService) {
