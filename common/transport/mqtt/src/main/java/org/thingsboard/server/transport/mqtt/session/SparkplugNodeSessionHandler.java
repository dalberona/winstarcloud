...
import org.winstarcloud.server.common.adaptor.ProtoConverter;
...
import org.winstarcloud.server.gen.transport.TransportApiProtos;
...
import org.winstarcloud.server.transport.mqtt.MqttTransportHandler;
import org.winstarcloud.server.transport.mqtt.util.sparkplug.MetricDataType;
...
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.SparkplugConnectionState.ONLINE;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.SparkplugMessageType.DBIRTH;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.SparkplugMessageType.NBIRTH;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.SparkplugMetricUtil.createMetric;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.SparkplugMetricUtil.fromSparkplugBMetricToKeyValueProto;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.SparkplugMetricUtil.validatedValueByTypeMetric;
import static org.winstarcloud.server.transport.mqtt.util.sparkplug.SparkplugTopicUtil.parseTopicSubscribe;
...
public class SparkplugNodeSessionHandler extends AbstractGatewaySessionHandler<SparkplugDeviceSessionContext> {
    ...
    public void setNodeBirthMetrics(java.util.List<org.winstarcloud.server.gen.transport.mqtt.SparkplugBProto.Payload.Metric> metrics) {
    ...
    public void onAttributesTelemetryProto(int msgId, SparkplugBProto.Payload sparkplugBProto, SparkplugTopic topic) throws AdaptorException, WinstarcloudException {
    ...
    public void handleSparkplugSubscribeMsg(List<Integer> grantedQoSList, MqttTopicSubscription subscription,
                                            MqttQoS reqQoS) throws WinstarcloudException {
    ...
    private ListenableFuture<SparkplugDeviceSessionContext> onDeviceConnectProto(SparkplugTopic topic) throws WinstarcloudException {
        try {
            ...
            throw new WinstarcloudException(e, WinstarcloudErrorCode.BAD_REQUEST_PARAMS);
        }
    }
    ...
    private List<TransportProtos.PostTelemetryMsg> convertToPostTelemetry(SparkplugBProto.Payload sparkplugBProto, Set<String> attributesMetricNames, String topicTypeName) throws AdaptorException {
        try {
            ...
            return msgs;
        } catch (IllegalStateException | JsonSyntaxException | WinstarcloudException e) {
    ...
    private Optional<TransportProtos.PostAttributeMsg> getPostAttributeMsg(SparkplugBProto.Payload.Metric protoMetric) throws WinstarcloudException {
    ...
    protected void sendErrorRpcResponse(TransportProtos.SessionInfoProto sessionInfo, int requestId, WinstarcloudErrorCode result, String errorMsg) {
