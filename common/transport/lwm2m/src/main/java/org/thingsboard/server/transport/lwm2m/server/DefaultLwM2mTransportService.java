...
import org.winstarcloud.server.transport.lwm2m.secure.TbLwM2MAuthorizer;
import org.winstarcloud.server.transport.lwm2m.secure.TbLwM2MDtlsCertificateVerifier;
import org.winstarcloud.server.transport.lwm2m.server.store.TbSecurityStore;
...
import static org.winstarcloud.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.FIRMWARE_UPDATE_COAP_RESOURCE;
