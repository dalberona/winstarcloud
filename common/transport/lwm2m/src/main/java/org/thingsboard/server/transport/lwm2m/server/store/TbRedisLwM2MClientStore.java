...
import static org.winstarcloud.server.transport.lwm2m.server.store.util.LwM2MClientSerDes.deserialize;
import static org.winstarcloud.server.transport.lwm2m.server.store.util.LwM2MClientSerDes.serialize;
