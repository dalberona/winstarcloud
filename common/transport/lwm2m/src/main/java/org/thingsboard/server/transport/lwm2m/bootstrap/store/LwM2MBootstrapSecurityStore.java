 ...
 */
package org.winstarcloud.server.transport.lwm2m.bootstrap.store;
...
import org.winstarcloud.server.transport.lwm2m.secure.LwM2mCredentialsSecurityInfoValidator;
import org.winstarcloud.server.transport.lwm2m.secure.TbLwM2MSecurityInfo;
import org.winstarcloud.server.transport.lwm2m.server.LwM2mSessionMsgListener;
...
import static org.winstarcloud.server.transport.lwm2m.server.uplink.LwM2mTypeServer.BOOTSTRAP;
    ...
    private LwM2MBootstrapConfig getParametersBootstrap(TbLwM2MSecurityInfo store) {
        ...
        if (lwM2MBootstrapConfig != null) {
            ...
            if (this.getValidatedSecurityMode(lwM2MBootstrapConfig)) {
                ...
                helper.sendParametersOnWinstarcloudTelemetry(helper.getKvStringtoWinstarcloud(LOG_LWM2M_TELEMETRY, logMsg), sessionInfo);
                return null;
            }
        }
