 ...
 */
package org.winstarcloud.server.transport.lwm2m.server.ota;
...
import org.winstarcloud.server.common.data.ota.OtaPackageUpdateStatus;
...
import org.winstarcloud.server.transport.lwm2m.server.ota.firmware.FirmwareDeliveryMethod;
...
import org.winstarcloud.server.transport.lwm2m.server.ota.firmware.LwM2MClientFwOtaInfo;
import org.winstarcloud.server.transport.lwm2m.server.ota.firmware.LwM2MFirmwareUpdateStrategy;
import org.winstarcloud.server.transport.lwm2m.server.ota.software.LwM2MClientSwOtaInfo;
import org.winstarcloud.server.transport.lwm2m.server.ota.software.LwM2MSoftwareUpdateStrategy;
...
import org.winstarcloud.server.transport.lwm2m.server.store.TbLwM2MClientOtaInfoStore;
...
import static org.winstarcloud.server.common.data.ota.OtaPackageKey.STATE;
import static org.winstarcloud.server.common.data.ota.OtaPackageUpdateStatus.DOWNLOADED;
import static org.winstarcloud.server.common.data.ota.OtaPackageUpdateStatus.DOWNLOADING;
import static org.winstarcloud.server.common.data.ota.OtaPackageUpdateStatus.FAILED;
import static org.winstarcloud.server.common.data.ota.OtaPackageUpdateStatus.UPDATED;
import static org.winstarcloud.server.common.data.ota.OtaPackageUpdateStatus.UPDATING;
import static org.winstarcloud.server.common.data.ota.OtaPackageUpdateStatus.VERIFIED;
import static org.winstarcloud.server.common.data.ota.OtaPackageUtil.getAttributeKey;
import static org.winstarcloud.server.transport.lwm2m.server.ota.firmware.FirmwareUpdateResult.UPDATE_SUCCESSFULLY;
import static org.winstarcloud.server.transport.lwm2m.server.ota.software.SoftwareUpdateResult.NOT_ENOUGH_STORAGE;
import static org.winstarcloud.server.transport.lwm2m.utils.LwM2MTransportUtil.LOG_LWM2M_TELEMETRY;
...
public class DefaultLwM2MOtaUpdateService extends LwM2MExecutorAwareService implements LwM2MOtaUpdateService {
    ...
    private void sendStateUpdateToTelemetry(LwM2mClient client, LwM2MClientOtaInfo<?, ?, ?> fwInfo, OtaPackageUpdateStatus status, String log) {
        ...
        result.add(kvProto.build());
        helper.sendParametersOnWinstarcloudTelemetry(result, client.getSession(), client.getKeyTsLatestMap());
    }
