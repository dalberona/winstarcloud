 ...
 */
package org.winstarcloud.server.transport.lwm2m.server.downlink;
...
import static org.winstarcloud.server.transport.lwm2m.utils.LwM2MTransportUtil.createModelsDefault;
import static org.winstarcloud.server.transport.lwm2m.utils.LwM2MTransportUtil.fromVersionedIdToObjectId;
import static org.winstarcloud.server.transport.lwm2m.utils.LwM2MTransportUtil.getVerFromPathIdVerOrId;
import static org.winstarcloud.server.transport.lwm2m.utils.LwM2MTransportUtil.validateVersionedId;
...
public class DefaultLwM2mDownlinkMsgHandler extends LwM2MExecutorAwareService implements LwM2mDownlinkMsgHandler {
    ...
    private String validatePathObserveCancelAny(LwM2mPath nodePath, LwM2mPath lwPathObs, LwM2mClient client) throws WinstarcloudException {
        if (nodePath.equals(lwPathObs) || lwPathObs.startWith(nodePath)) {    // nodePath = "3",     lwPathObs = "3/0/9": cancel for tne all lwPathObs
            ...
            throw new WinstarcloudException(errorMsg, WinstarcloudErrorCode.BAD_REQUEST_PARAMS);
        }
        return null;
    }
