...
public class SecureClientNoAuth {
    ...
    private ExecutorService executor = Executors.newFixedThreadPool(1, WinstarCloudThreadFactory.forName(getClass().getSimpleName()));
    ...
    public static void main(String[] args) throws URISyntaxException {
        System.out.println("Usage: java -cp ... org.winstarcloud.server.transport.coap.client.SecureClientNoAuth " +
