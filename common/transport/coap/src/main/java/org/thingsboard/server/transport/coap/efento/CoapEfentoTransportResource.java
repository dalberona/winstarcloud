 ...
 */
package org.winstarcloud.server.transport.coap.efento;
...
import org.winstarcloud.server.gen.transport.coap.ConfigProtos;
import org.winstarcloud.server.gen.transport.coap.DeviceInfoProtos;
import org.winstarcloud.server.gen.transport.coap.MeasurementTypeProtos;
import org.winstarcloud.server.gen.transport.coap.MeasurementsProtos;
import org.winstarcloud.server.transport.coap.AbstractCoapTransportResource;
import org.winstarcloud.server.transport.coap.CoapTransportContext;
import org.winstarcloud.server.transport.coap.callback.CoapDeviceAuthCallback;
import org.winstarcloud.server.transport.coap.callback.CoapEfentoCallback;
import org.winstarcloud.server.transport.coap.efento.utils.CoapEfentoUtils;
...
import static org.winstarcloud.server.transport.coap.CoapTransportService.CONFIGURATION;
import static org.winstarcloud.server.transport.coap.CoapTransportService.CURRENT_TIMESTAMP;
import static org.winstarcloud.server.transport.coap.CoapTransportService.DEVICE_INFO;
import static org.winstarcloud.server.transport.coap.CoapTransportService.MEASUREMENTS;
