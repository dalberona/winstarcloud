 ...
 */
package org.winstarcloud.common.util;
 ...
 */
public class WinstarCloudThreadFactory implements ThreadFactory {
    ...
    public static WinstarCloudThreadFactory forName(String name) {
        return new WinstarCloudThreadFactory(name);
    }

    private WinstarCloudThreadFactory(String name) {
