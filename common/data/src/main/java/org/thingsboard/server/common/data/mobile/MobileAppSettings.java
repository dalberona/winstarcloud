 ...
 */
package org.winstarcloud.server.common.data.mobile;
...
import org.winstarcloud.server.common.data.id.MobileAppSettingsId;
...
public class MobileAppSettings extends BaseData<MobileAppSettingsId> implements HasTenantId {
    ...
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "Type of application: true means use default Winstarcloud app", example = "true")
