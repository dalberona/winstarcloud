...
public class UpdateMessage implements Serializable {
    ...
    @Schema(description = "Current WinstarCloud version.")
    private final String currentVersion;
    @Schema(description = "Latest WinstarCloud version.")
    private final String latestVersion;
    @Schema(description = "Upgrade instructions URL.")
    private final String upgradeInstructionsUrl;
    @Schema(description = "Current WinstarCloud version release notes URL.")
    private final String currentVersionReleaseNotesUrl;
    @Schema(description = "Latest WinstarCloud version release notes URL.")
