...
import org.winstarcloud.server.queue.util.PropertyUtils;
...
public class TbAwsSqsAdmin implements TbQueueAdmin {
    ...
    public TbAwsSqsAdmin(TbAwsSqsSettings sqsSettings, Map<String, String> attributes) {
        ...
        producerExecutor = WinstarCloudExecutors.newWorkStealingPool(sqsSettings.getThreadPoolSize(), "aws-sqs-queue-executor");
