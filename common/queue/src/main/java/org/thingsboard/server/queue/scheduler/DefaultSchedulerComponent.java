 ...
 */
package org.winstarcloud.server.queue.scheduler;
...
public class DefaultSchedulerComponent implements SchedulerComponent {
    ...
    @PostConstruct
    public void init() {
        this.schedulerExecutor = Executors.newSingleThreadScheduledExecutor(WinstarCloudThreadFactory.forName("queue-scheduler"));
    }
